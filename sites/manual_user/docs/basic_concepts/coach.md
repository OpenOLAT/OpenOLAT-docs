...
| Survey         | Display of survey results/statistics                                           |                             |
...
| File dialog | Create postings and file upload can be activated, but no access to the [storage folder](../learningresources/Storage_folder.md); forum part like course element forum; forum part like course element "Forum" |Optional moderator rights for the forum part can be activated  |
...
| E-mail | send emails = participant|  |
