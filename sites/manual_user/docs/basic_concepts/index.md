...
Not all users can do everything in OpenOlat. There are different roles, each with different rights. This ranges from administrators to the guest access, which understandably has few rights associated with it.
...
Here you can learn more about the tools used to develop OpenOlat. Besides, various supporting technologies are used, e.g. WebDAV or a special editor for math formulas.
