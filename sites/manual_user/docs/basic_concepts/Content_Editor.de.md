...
### Import von Markdown-Dateien {: #markdown}
...
Klicken Sie zum Import auf den Button am unteren Rand des Content Editors. Sie haben die Möglichkeit, eine komplette Datei zu importieren oder Markdown-formatierten Text in ein Eingabefeld zu übernehmen. 
...
### Import von Word-Dateien {: #word}

Auf die gleiche Art wie Markdown-Dateien, können auch Word-Dateien ab Version 20.3 importiert werden.

![content_editor_content_markdown3_v1_de.png](assets/content_editor_content_markdown3_v1_de.png){ class="shadow lightbox" }

!!! info "Hinweis"

    Nicht alle Word-Funktionen können in den Content Editor importiert werden. Die Konvertierung von Bildern ist möglicherweise nicht vollständig kompatibel. Bitte überprüfen Sie die importierten Inhalte sorgfältig.
...
### Andere & Design {: #others_and_design}
