...
![Startseite festelegen](assets/DE_startseite_festlegen.png)

 
### Persönliche Werkzeuge

Hier wählen Sie aus, welche persönlichen Werkzeuge
...
![Liste der persönlichen Werkzeuge](assets/persoenliche_Werkzeuge_20.png)

Werkzeuge die nicht als Schnellzugriff in der Navigationsleiste liegen, sind
als Menüeintrag im persönlichen Menü verfügbar. Mit Hilfe kommen Sie zu verschiedenen Hilfsangeboten wie beispielsweise das OpenOlat Handbuch und mit "Drucken" können Sie die aktuell
...
Als letztes haben Sie unter "Einstellungen Zurücksetzen" im Tab "System" die Möglichkeit,
ihre vorgenommenen systembezogenen Änderungen wieder **auf die Standardeinstellungen zurückzusetzen**. Zurückgesetzt werden können Einstellungen der Bildschirmkomponenten, Systemeinstellungen wie Benachrichtigungen sowie der Einstellungen zur Wiederherstellung der letzten Sitzung. 
...
![Instant Messaging](assets/Instant_Messageing_20.png)

### Tab Nutzungsbedingungen

Hier können Sie die Nutzungsbedingungen nachlesen, welche Sie beim ersten
Login bestätigt haben. Die genauen Nutzungsbedingungen werden von den OpenOlat
Administrator:innen festgelegt.
