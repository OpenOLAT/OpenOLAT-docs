# :o_icon_o_icon_user: Persönliche Konfiguration: Profil

![pers_menu_profile_v1_de.png](../personal_menu/assets/pers_menu_profile_v1_de.png){ class="aside-right lightbox"}

Im persönlichen Menü, Abschnitt "Konfiguration", unter der Option "Profil" können Sie Ihre persönlichen
...
<details>
	...
	Sollte die Möglichkeit zur Eingabe Ihrer E-Mail-Signatur nicht angezeigt werden, wenden Sie sich bitte an Ihren/Ihre Administrator:in.
...
Im Bereich "Über mich" können Sie bei Bedarf einige Informationen als Freitext
über sich eintragen.
...
!!! tip "Tipp"
    ...
    Um sich die Visitenkarten anderer OpenOlat-Benutzer:innen anzuschauen, wählen Sie
    **Personensuche** im persönlichen Menü und suchen die gewünschte Person über
    die Suchmaske.
