...
If the OpenOlat [Administrator](../../manual_admin/administration/Modules_Organisations.md) has stored invoice addresses for the individual bookings, these can be read out in the Invoice addresses tab.
