# ![icon_todo.png](assets/icon_todo.png) Persönliche Werkzeuge: To-dos {: #to_dos}
...
Alle OpenOlat User finden bei den «Persönlichen Werkzeugen» ihre To-dos, die ihnen in unterschiedlichen OpenOlat Kontexten zugewiesen wurden: im Kurs, im Projekt, im Qualitätsmanagement und im Course Planner. [:octicons-tag-16:{ title="ab Release 21.0 (OO-9417)" }](https://track.frentix.com/issue/OO-9417){:target="_blank"}
Ferner können alle User hier eigene, individuelle To-dos erstellen und managen.
...
[To-dos im Course Planner >](../area_modules/Course_Planner_Todos.de.md)<br>
