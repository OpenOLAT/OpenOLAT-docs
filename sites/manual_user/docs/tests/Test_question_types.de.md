...
Benutzer wählen aus einer von drei Antwortoptionen aus: "Unbeantwortet",
...
![](assets/3Punkte_Luecke.jpg)
![](assets/Lueckeneditor.jpg)
...
- [x] Zuerst werden ein kurzer Titel und die Frage eingegeben.
- [x] Anschliessend wird das gewünschte Bild hochgeladen.
- [x] Dann können Spots in Form von Kreis oder Viereck auf dem Bild platziert werden. In der erweiterten Bearbeitung lassen sich Spots auch einfach
duplizieren.
- [x] Zum Schluss müssen noch die korrekten Antworten ausgewählt werden.
...
![](assets/image2021-8-6_10-57-49.png)  
...
??? abstract "Exkurs: Aufsatz per Test – Aufsatz schreiben"
