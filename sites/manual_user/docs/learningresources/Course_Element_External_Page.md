...
*  _Integrated completely (source hidden):_ The external HTML page will be parsed and integrated in your OpenOlat page completely. HTML pages may only contain resources such as images, Flash, videos or links with **relative paths**. Absolute paths such as "http://..." and relative absolute paths such as "/public" (relative to a base URI) are not allowed.

*  _Embedded (source hidden):_ The external HTML page will be included in a so-called «iframe». The external page's Internet address will not be visible to participants. HTML pages may only contain resources such as images, Flash, videos or links with **relative paths**. Absolute paths such as "http://..." and relative absolute paths such as "/public" (relative to a base URI) are not allowed.

*  _Embedded (source visible):_ This also means including your external HTML page in an «iframe». The source code of the OpenOlat page will show you the external page's Internet address.
