...
Die Lernressource Formular wird im Kursbaustein "Umfrage" in Form eines Fragebogens verwendet. Kursbesitzer:innen können so Fragebögen in ihren Kurs einbinden, und Lernende können die bereitgestellten Umfragen ausfüllen. Die Ergebnisse werden den Kursbesitzer:innen und Betreuer:innen entsprechend angezeigt.

OpenOlat stellt sicher, dass Teilnehmende die Umfrage bzw. den Fragebogen nur einmal ausfüllen können. Die Resultate werden standardmässig anonymisiert gespeichert. Eine Personalisierung ist jedoch durch die Auswahl der passenden Formularelemente im [Formular-Editor](../learningresources/Form_Editor.de.md) möglich.
...
![Tabs des Kursbausteins Umfrage im Kurseditor: Titel und Beschreibung, Layout, Lernpfad, Umfrage](assets/Umfrage_Kurseditor.png){ class="shadow lightbox" }

Im Tab "Titel und Beschreibung" sowie "Layout" können allgemeine Beschreibungen und Informationen zum jeweiligen Kursbaustein hinterlegt und die optische Darstellung definiert werden. Im [Tab Lernpfad](../learningresources/Learning_path_course_Course_editor.de.md) werden spezielle Einstellungen, die für Lernpfadkurse gelten, definiert, z.B. kann als Erledigungskriterium "Umfrage teilgenommen" gewählt werden.

Herkömmliche Kurse verfügen dagegen über die Tabs "Sichtbarkeit" und "Zugang". Hier wird definiert, wer diesen Kursbaustein sehen bzw. bearbeiten kann.
...
![Auswahl eines Formulars aus den eigenen Einträgen im Dialog Formular auswählen](assets/Formular_auswahlmenue1.jpg){ class="shadow lightbox" }
...
![Tab Umfrage mit ausgewähltem Formular und den Buttons Ersetzen und Bearbeiten](assets/Umfrage_Tab.png){ class="shadow lightbox" }

Anschliessend kann definiert werden, wer die Umfrage ausfüllen und wer die Ergebnisse der Umfrage sehen kann. Folgende Optionen können jeweils gewählt werden:
...
* Gäste: Personen ohne OpenOlat-Konto

Aktiviert man die erweiterte Konfiguration, können noch weitere Einstellungen vorgenommen werden: Zum Beispiel lassen sich bestimmte Zeiträume der Teilnahme für bestimmte Rollen definieren und die Teilnahme auf bestimmte Gruppen einschränken.

Auch die Ergebnisse können für all diese Gruppen freigegeben und in der erweiterten Konfiguration mit einem Beginn- und Enddatum verbunden werden.

!!! tip "Kurs für die jeweilige Personengruppe freigeben"

    Voraussetzung für die Bearbeitung der Umfrage ist jedoch, dass der gesamte Kurs auch für die jeweilige Personengruppe freigegeben ist. Soll also beispielsweise eine Umfrage auch von externen Personen (Gästen) ausfüllbar sein, muss auch der Kurs im Menü "Einstellungen" > [Freigabe](../learningresources/Access_configuration.de.md) "offen ohne Buchung" für Gäste freigegeben sein.
...
!!! warning "Formular nach erster Ansicht nicht mehr ersetzbar"
...
![Meldung Formular ausgefüllt nach dem Absenden der Umfrage](assets/Umfrage_ausgefuellt.jpg){ class="shadow lightbox" }

Die Umfrage kann nur einmal ausgefüllt und nach dem Abschicken nicht mehr geändert werden. Die Person sieht eine entsprechende Information. Soll der Fragebogen noch nicht direkt abgeschickt werden, kann die Option "Zwischenspeichern" verwendet werden.
...
**Übersicht**: Hier erfährt man, wie viele Personen den Fragebogen ausgefüllt haben, den Abgabezeitraum sowie die Bearbeitungsdauer. Je nach Fragetyp werden auch noch weitere Kennzahlen aufgeführt.
...
**Einzelne Formulare**: Hier hat man Zugriff auf die gesamten ausgefüllten, anonymen Fragebögen einzelner Personen.
...
Kursbesitzer:innen können schon ausgefüllte Fragebögen auch über den Link "Zurücksetzen" im 3-Punkte-Menü des jeweiligen Kursbausteins zurücksetzen. In diesem Fall werden alle bereits eingereichten Fragebögen für diese Umfrage gelöscht. Ein Zurücksetzen von einzelnen Fragebögen ist nicht möglich, da die Abgabe anonym erfolgt.

![3-Punkte-Menü mit dem Link Zurücksetzen in der Umfrage-Auswertung](assets/Umfrage_zuruecksetzen.jpg){ class="shadow lightbox" }

## Weiterführende Informationen {: #further_information}

[Formular-Editor >](../learningresources/Form_Editor.de.md)<br>
...
[Zum Seitenanfang ^](#formular-in-umfragen)
