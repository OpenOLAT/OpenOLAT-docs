...
![Menüpunkt "Inhalt exportieren" im Administrationsmenü einer Lernressource](assets/course_export_content_v1_de.png){ class="shadow lightbox" }
...
[Zur Freigabe für andere Autor:innen >](../learningresources/Access_configuration.de.md)
