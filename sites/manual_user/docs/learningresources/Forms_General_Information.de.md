...
In Formularen stehen verschiedene Fragetypen zur Verfügung, etwa Rubrik, Einzelauswahl, Mehrfachauswahl, Texteingabe oder Datei-Upload. Jedes Formular besteht aus einer Seite mit einer oder mehreren Fragen bzw. Elementen, die in ein oder mehrere Layouts eingebettet sind. Über [Frageregeln](../learningresources/Form_Question_Rules.de.md) ist auch eine Verzweigung möglich.
