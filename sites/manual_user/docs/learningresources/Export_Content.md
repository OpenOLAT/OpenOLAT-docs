...
![Menu item "Export content" in the administration menu of a learning resource](assets/course_export_content_v1_de.png){ class="shadow lightbox" }
...
[Shared to other authors >](../learningresources/Access_configuration.md)
