...
![Icon "Termine" in der Toolbar eines Kurses aus Sicht der Teilnehmer:innen](assets/toolbar_events_participant1_v1_de.png){ class="shadow lightbox"}
...
![Terminliste eines Kurses aus Sicht der Teilnehmer:innen mit Tabs, Filtern und Statuslabels](assets/toolbar_events_participant2_v1_de.png){ class="shadow lightbox"}
...
![Dialog zum Abschliessen eines Termins mit effektiven Einheiten und Bemerkung](assets/toolbar_events_coach_close_event_v1_de.png){ class="shadow lightbox"}
...
![Tab "Rekurse" mit dem Filter für pendente, angenommene und abgelehnte Rekurse](assets/toolbar_events_coach_tab_appeals_v1_de.png){ class="shadow lightbox" }
...
![Icon "Termine" in der Toolbar aus Sicht der Kursbesitzer:innen](assets/toolbar_events_owner1_v1_de.png){ class="shadow lightbox"}
