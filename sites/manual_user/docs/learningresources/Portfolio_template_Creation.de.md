...
1. Gehen Sie in den Autorenbereich und klicken Sie auf den Button "Erstellen". Wählen Sie in der erscheinenden Lernressourcen Liste "Portfolio 2.0 Vorlage" aus.
    ...
    ![Portfolio Vorlage im Autorenbereich erstellen](assets/Portfolio_Vorlage_erstellen_20.jpg){ class="shadow lightbox" }
...
5. Auch die weiteren Tabs [Info](../learningresources/Course_Settings_Info.de.md), [Metadaten](../learningresources/Course_Settings_Metadata.de.md) und [Freigabe](../learningresources/Access_configuration.de.md) können weiter eingerichtet werden.  
