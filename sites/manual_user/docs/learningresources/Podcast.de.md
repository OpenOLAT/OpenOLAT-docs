...
Der Begriff "Podcasting" bildet sich aus den beiden Wörtern "iPod" und "Broadcasting" und bezeichnet das Produzieren und Anbieten von Audio- und Videodateien. Podcasts kann man abonnieren und die Episoden entweder über Portale wie iTunes auf mobile Endgeräte herunterladen, oder direkt in OpenOlat konsumieren. Die Episoden werden zeitlich sortiert angezeigt, die neuesten Meldungen erscheinen immer oben. Teilnehmende können Episoden bewerten und Kommentare dazu verfassen.
...
Die Lernressource Podcast kann direkt im Autorenbereich erstellt werden. Unter "Meine Einträge" werden u.a. alle Podcast Lernressourcen angezeigt die man selbst erstellt hat oder bei denen man Besitzer:in ist. 
...
[Podcast konfigurieren >](../learningresources/Podcast_Configuration.de.md)
