...
As an informational work aid that supports participants in completing smaller tasks, for example, or in keeping information secure, the checklist allows participants to keep to-do or check lists, for example. For example, tasks outside of OpenOlat can also be documented. If this is the case, you may find information about the evaluation on the start page of the checklist.
...
By means of the course element "Checklist" you add a checklist to your course. For each course element, create a checklist with as many checkboxes as needed. Create individual checkboxes in the tab "Checkboxes" via the button "Add checkbox". You can also assign points to the checkboxes and add files for download.
 ...
 **Score granted**: If you assign points to the individual checkboxes in the "Checkboxes" tab, you can manually or automatically award points to participants for marked check boxes. If you do not check this box no score will be allocated.
 ...
 **Individual comment**: When checking this box, you have the possibility to give each participant an individual comment during the assessment.

## Tab Checkboxes [:octicons-tag-16:{ title="from Release 15.1 (OO-4758)" }](https://track.frentix.com/issue/OO-4758){:target="_blank"}

In this tab you create and edit the checkboxes that can subsequently be ticked. Click the button "Add checkbox" in order to create a new checkbox. A form opens in a pop-up.
 ...
 **Label**: You can select from 11 different types of checkboxes: Achieved, Done, Processed, Fulfilled, Passed, Presented, Verified, Attendant, Read, Viewed and Confirmed. Choose the one most appropriate for your purpose.
...
![Multiple checklists icon](assets/wizard_434343_64.png)
...
In the **first** step, create a template for the checklist group to be created by defining the type and number of checkboxes, and configure it in the second step. All lists and settings can be edited separately in the course editor after creation.
...
For more information on the checklist configuration, please refer to the Checklist: configuration. If you configured the checklists to have a deadline, you can define the date in the third step.
