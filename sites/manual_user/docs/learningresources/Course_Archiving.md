...
![Menu entry Course archive in the 3-dot menu of the top button row in the authoring area](assets/course_archiving_open_v1_de.png){ class="shadow lightbox" }
...
![Course archive page with the tabs Course archives and Course archive management, and the list of created archive files](assets/course_archiving_all_v1_de.png){ class="shadow lightbox" }
...
![Menu entry Archiving & Reports in the Administration menu of a course](assets/course_archiving_create_single_v1_de.png){ class="shadow lightbox" }

![Course archiving tab with the Create archive button to create a new course archive](assets/course_archiving_create_single2_v1_de.png){ class="shadow lightbox" }
...
![Course archiving dialog with the choice between complete archive and partial archive](assets/course_archiving_create_partial_v1_de.png){ class="shadow lightbox" }
...
![Archive course button in the button row above the course list in the authoring area](assets/course_archiving_create_multiple_v1_de.png){ class="shadow lightbox" }
...
![Course archive management tab with the archives of all authors and the menu Show metadata, Download, Delete](assets/course_archiving_management_v1_de.png){ class="shadow lightbox" }
...
!!! note "Note"
    ...
    ![Export results button in the Participants tab of a Test course element](assets/Test_Resultate_exportieren1.png)
