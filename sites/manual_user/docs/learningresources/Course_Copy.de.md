...
![Menüpunkt Kopieren im aufgeklappten Menü Administration eines Kurses](assets/course_copy_v1_de.png){ class="shadow lightbox" }

Sie finden diese Option im Kurs unter `Kurs > Administration > Kopieren`.
