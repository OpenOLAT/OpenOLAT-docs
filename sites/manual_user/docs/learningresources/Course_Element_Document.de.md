...
### Für welche Dateitypen ist der Kursbaustein gedacht? :octicons-tag-16:{ title="ab Release 15.3 (OO-4801)" }

Der Kursbaustein ist gut geeignet für die Anzeige von PDF- und auch JPG- und PNG-Dateien. Darüber hinaus können auch, sofern vom OpenOlat Administrator aktiviert, Office-Dokumente (Word, Excel, PowerPoint) und draw.io Diagramme :octicons-tag-16:{ title="ab Release 18.1 (OO-7090)" } eingebunden werden.

Ab Release 18.1 verwendet OpenOlat für PDF-Dateien einen integrierten PDF-Viewer (pdf.js) :octicons-tag-16:{ title="ab Release 18.1 (OO-6996)" }, der eine deutlich bessere Darstellung als die frühere OnlyOffice-Ansicht bietet. Grosse PDF-Dateien werden dabei stufenweise geladen, sofern die Datei dies unterstützt. Der PDF-Viewer ist schreibgeschützt — zum Bearbeiten wird ein separater Editor benötigt.
...
### Wie kommen die Dateien in den Kursbaustein? :octicons-tag-16:{ title="ab Release 15.3 (OO-4801)" }
...
#### Datei hochladen :octicons-tag-16:{ title="ab Release 15.3 (OO-4801)" }
...
#### Datei verknüpfen :octicons-tag-16:{ title="ab Release 15.3 (OO-4801)" }
...
#### Datei erstellen :octicons-tag-16:{ title="ab Release 15.3 (OO-4801)" }
...
Sofern **draw.io Diagramme** :octicons-tag-16:{ title="ab Release 18.1 (OO-7090)" } von den OpenOlat Administrator:innen aktiviert wurde, können im Kursbaustein Dokument auch draw.io Diagramme erstellt und für die User bereitgestellt werden. Wählen Sie hierfür die Option "Dokument erstellen" → "Mehr Formate anzeigen" → "Diagramm" oder "Whiteboard".

draw.io Diagramme unterstützen das gleichzeitige Bearbeiten durch mehrere Personen :octicons-tag-16:{ title="ab Release 18.1 (OO-7091)" }. Mehrere Teilnehmende können ein Diagramm gleichzeitig öffnen und bearbeiten — Änderungen werden in Echtzeit synchronisiert. Damit eignet sich der Kursbaustein Dokument mit draw.io für kollaborative Gruppenarbeiten.
...
### Höhe der Vorschau konfigurieren :octicons-tag-16:{ title="ab Release 15.4 (OO-5116)" }
...
### Dokument-Anzeige im Lightbox-Modus :octicons-tag-16:{ title="ab Release 18.1 (OO-6957)" }
...
### Änderungen vornehmen :octicons-tag-16:{ title="ab Release 15.3 (OO-4801)" }
...
### Berechtigungen konfigurieren :octicons-tag-16:{ title="ab Release 15.3 (OO-4801)" }
