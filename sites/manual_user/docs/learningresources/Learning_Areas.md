...
![Administration button and Learning area menu item marked in the open administration menu of a course.](assets/course_learning_areas_v1_de.png){ class="shadow lightbox" }
