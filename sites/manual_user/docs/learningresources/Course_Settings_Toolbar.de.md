...
![Tab "Toolbar" der Kurseinstellungen mit Checkbox "Toolbar sichtbar für Teilnehmer:innen" und Liste der aktivierbaren Werkzeuge](assets/course_settings_toolbar1_v1_de.png){ class="shadow lightbox"}

Auf diesem Weg können Tools, die kontinuierlich zur Verfügung stehen sollen, an einer zentralen Stelle aufgerufen werden.

**Beispiel:**

![Toolbar im Kurs mit den aktivierten Werkzeugen Kursinfo, Lernpfad, Kalender, BigBlueButton und Kurssuche](assets/course_settings_toolbar_v1_de.png){ class="shadow lightbox" }
...
![Konfigurationsformular für "Externes Kurstool 1" mit den Feldern Name, URL, Icon und Sichtbar für](assets/course_settings_toolbar_external_tools_v1_de.png){ class="shadow lightbox"}
...
![Kurs-Toolbar mit dem externen Kurstool "Zeiterfassung" als zusätzlichem Symbol](assets/course_toolbar_with_external_tools_v1_de.png){ class="shadow lightbox"}
