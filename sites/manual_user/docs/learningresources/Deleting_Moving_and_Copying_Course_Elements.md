...
You can make changes to your course in the course editor. You get there by starting the course and selecting `Course > Administration > Course editor`.
...
![Four steps of the wizard Import course elements: Select course, Select course elements, Confirm course elements, Select files](assets/Weg_importieren_KB.png){ class="shadow lightbox" }
...
c) All selected course elements will be displayed to you once again. For some course elements such as podcast, blog, wiki, task, group task or folder, even more settings can be made for the copy process. For example, the files of the course element folder can be copied as well. A blog, wiki, or podcast can either be reused, newly created, or
not configured further for the moment. In the case of tasks and group tasks, the stored task definition and the sample solution can be copied or not.
...
[To the top of the page ^](#deleting-moving-and-copying-course-elements)
