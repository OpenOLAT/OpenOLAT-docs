...
Auf Wunsch können auch Teilarchive erstellt werden, wenn z.B. nur die Ergebnisse eines best. Kursbausteins archiviert werden sollen. (Z.B. der Abschlusstest und Übungstests sollen nicht im Archiv enthalten sein.)

Ein solches Kursarchiv ist zu unterscheiden von der Option "Inhalt exportieren" in der Kursadministration. 
...
!!! info "Hinweis"
    ...
    Im Kursarchiv werden alle von Ihnen erstellten Archive aufgelistet. <br>Administrator:innen und Lernressourcenmanager:innen sehen unter Kursarchive auch nur die von Ihnen selbst erstellten Archive oder Kurse, in denen sie Besitzer sind. <br>Im Tab Kursarchiv**management** werden Administrator:innen dagegen die Archive aller Autor:innen aufgelistet.
...
### Mehrere Kurse im Autorenbereich archivieren
...
!!! info "Hinweis"
    ...
    Dieser Tab ist nur für Administrator:innen und Lernressourcenmanager:innen verfügbar.
