...
!!! note "Open Source Lösung BigBlueButton"
    ...
    BigBlueButton ist eine Open Source Lösung für virtuelle Konferenz-, Meeting und Klassenraum-Szenarien. Die offiziellen Dokumentationen und Hilfestellungen finden Sie unter den nachfolgenden Links. Die Zusammenstellung der häufigsten Fragen (FAQ) auf dieser Seite ist nicht abschliessend und bezieht sich auf die Nutzung von BigBlueButton in Kombination mit OpenOlat.
...
## :material-devices: Geräte, Browser & Fehlermeldungen
...
Es eignen sich alle Geräte, welche die Browser-Voraussetzungen (vgl. oben) erfüllen. Mobile Geräte wie Smartphones und Tablets werden ebenfalls unterstützt - bieten teilweise nicht den vollen Funktionsumfang (bspw. für Moderierende/Dozierende).

**Kann ich das Whiteboard von BigBlueButton mit dem Tablet (bspw. iPad) nutzen?**

Ja - dieses Setup ist möglich. Dazu sollte das Meeting über einen externen Gästelink verfügen. Melden Sie sich dazu mit Ihrem normalen Account als Betreuer:in im Meeting an und zusätzlich melden Sie sich mit dem Tablet über den Gästelink an. Wir empfehlen dabei einen Benutzernamen wie "Peter Meier - iPad". Via Rechtsklick auf die über das Tablet angemeldete Person können Sie diese zum Präsentator aufstufen und können anschliessend auf dem Tablet die Präsentation steuern und die Whiteboard-Funktion benutzen (Tipp: Den Upload der Präsentation können Sie zu Beginn mit Ihrem normalen Account erledigen).
...
1003| Der gewählte Browser wird nicht unterstützt (ggf. wird eine veraltete Version des Browsers eingesetzt)
...
Folgende Möglichkeiten stehen zur Problembehebung zur Verfügung:
  ...
  * Haben Sie noch ein anderes Konferenz-Tool geöffnet wie Microsoft Teams, Skype, weitere Browserfenster mit ähnlichen Funktionen, Wire etc.
  ...
  * Starten Sie Ihren Browser neu oder verwenden Sie einen alternativen Browser
...
* In einigen Setups können nur Moderierende die Kamera aktivieren - nicht aber die Teilnehmenden (die Moderation kann Sie temporär zu Co-Moderierenden aufstufen)
...
* Haben Sie noch ein anderes Video-Konferenz-Tool geöffnet wie Microsoft Teams, Skype, weitere Browserfenster mit ähnlichen Funktionen, Wire etc.
* Starten Sie Ihren Browser neu oder verwenden Sie einen alternativen Browser
* Starten Sie Ihren PC oder Ihr Notebook neu


**Die Präsentation ist zu klein und die Videos der Teilnehmenden und Moderierenden sind sehr gross. Wie kann ich das verändern?**
...
Für das Abspielen von Videos eignet sich die separate Funktion "Externes Video teilen" - dazu müssen Sie das Video vorgängig über YouTube oder Vimeo bereitstellen.<br>
...
Der Dialog zur Selektion eines spezifischen Fensters/Applikation oder eines zweiten Monitors wird nur in Google Chrome angezeigt. Das Screensharing kann teilweise auch in anderen Browsern aktiviert werden, teilt aber direkt und ausschliesslich den Bildschirm mit dem aktuellen BigBlueButton-Meeting-Fenster.

## :material-record: Aufzeichnungen (Recordings)

**Welche Bereiche werden bei einer Aufzeichnung erfasst?**
...
_Die Aufzeichnung beinhaltet:_ Sämtliches Audio, alle aktivierten Kameras, Präsentationen/Screensharing, Notizen auf Folien (Whiteboard-Aktivitäten), gemeinsamer Chat

**Ab wann steht die Aufzeichnung im OpenOlat-Kurs zur Verfügung?**

Allfällige Aufzeichnungen stehen einige Minuten nach Abschluss/Beendigung des Meetings in OpenOlat zur Verfügung. Unter "Abgelaufene Online-Termine" können Sie die Publikation steuern.
