...
Sie erreichen das Bewertungswerkzeug über `Kurs > Administration > Bewertungswerkzeug`. Wenn Sie das Bewertungswerkzeug aufrufen, erscheint zunächst die Übersichtsseite mit zentralen Informationen sowie eine Übersicht der aktuell anstehenden Bewertungen und Aktionen. So wissen Sie schnell, was aktuell zu tun ist. Von der Übersichtsseite aus gelangen Sie auch zu den konkreten Bewertungsbereichen der einzelnen Kursbausteine und Personen.

![Übersichtsseite des Bewertungswerkzeugs mit Teilnehmer:innen-Statistik, Prüfungsmodus, offenen und freizugebenden Bewertungen sowie Benachrichtigungsservice](assets/Bewertungswerkezuge_191.png){ class="shadow lightbox" }
...
![Liste der offenen Bewertungen je Kursbaustein und Teilnehmer:innen im Bewertungswerkzeug](assets/offene_Bewertungen.jpg){ class="shadow lightbox" }
...
![Liste der noch nicht freigegebenen Bewertungen je Kursbaustein und Teilnehmer:innen im Bewertungswerkzeug](assets/freizugebende_Bewertungen.png){ class="shadow lightbox" }
...
![Teilnehmer:innen-Statistik mit Punkteverteilung, bestandenen Kursmitgliedern sowie Gruppen und Curriculumelementen in der Übersicht des Bewertungswerkzeugs](assets/Uebersicht_Bewertungswerkzeug.jpg){ class="shadow lightbox" }
...
![Laufende und geplante Prüfungen mit Beginn, Ende und Teilnehmerzahl im Bereich Prüfungsmodus des Bewertungswerkzeugs](assets/Pruefng1_Bewertungswerkzeug1.jpg){ class="shadow lightbox" }

Auch ist hier erkennbar wie viele Personen bereits eingeloggt sind und auf den Start der Prüfung warten.

![Geplante Prüfung mit wartenden Teilnehmenden und Button "Prüfung starten" im Bewertungswerkzeug](assets/Pruefung_starten.jpg){ class="shadow lightbox" }
...
![Abonnieren-Schieberegler für Benachrichtigungen zu neuen Testresultaten und Zertifikaten im Bewertungswerkzeug](assets/Benachrichtigungen_Bewertungswerkzeug20.jpg){ class="shadow lightbox" }
...
![Bereich "Aufträge" mit Tabs für offene Bewertungen, offene Einstufungen und freizugebende Bewertungen im Bewertungswerkzeug](assets/Auftraege1.jpg){ class="shadow lightbox" }

## Prüfungseinsicht [:octicons-tag-16:{ title="ab Release 18.2 (OO-7425)" }](https://track.frentix.com/issue/OO-7425)
...
![Tab "Prüfungseinsicht" eines Kursbausteins mit Teilnehmerliste, Einsichtszeitraum und Status](assets/Pruefungseinsicht_Baustein1.jpg){ class="shadow lightbox" }
...
Im Übersichtstab erscheinen ähnliche Informationen wie im Übersichtsbereich des Bewertungswerkzeugs, nur Kursbaustein bezogen, also z.B. die Punkteverteilung, Anzahl der Bewertungen, Infos zum Bestehen usw. 
...
Wie genau Bewertungen vorgenommen werden erfahren Sie im Kapitel ["Bewertung von Kursbausteinen"](../learningresources/Assessment_of_course_modules.de.md) bzw. ["Lernende bewerten"](../learningresources/Assessment_of_learners.de.md).
...
![Wizard-Schritt "Kursbaustein auswählen" für die Massenbewertung mit Liste der bewertbaren Kursbausteine](assets/Massenbewertung_wizard.png){ class="shadow lightbox" }
