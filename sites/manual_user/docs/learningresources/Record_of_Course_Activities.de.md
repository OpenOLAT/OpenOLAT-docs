...
OpenOlat zeichnet Kursaktivitäten der Teilnehmenden und Kursautoren in Logfiles auf.
...
![Logfile-Auswahl mit Datumsbereich und Schaltfläche "Archivieren" im Bereich "Archivierung & Reporting" der Kursadministration](assets/Kuraktivitaeten_logfiles_182.png){ class="shadow lightbox" }

!!! info "Datenschutz"

    Aus Datenschutzgründen ist das Teilnehmer:innen-Logfile mit den personalisierten Daten der Teilnehmenden nur für Systemadministratoren verfügbar.

Kursbesitzer und sonstige Personen, welche die Berechtigung zur Archivierung haben, können die gewünschten Logfiles als ZIP-Datei (z.B. _CourseLogFiles_2010-01-28_14-55-55.zip_ ) in Ihren [persönlichen Dateien](../personal_menu/File_Hub.de.md#personal_files) abspeichern. Die ZIP-Datei enthält dann die ausgewählten Dateien _course_statistic_log.xlsx_, _course_admin_log.xlsx_ und _course_user_log.xlsx_.
...
[Zur Datenarchivierung >](../learningresources/Course_Archiving.de.md)<br>
