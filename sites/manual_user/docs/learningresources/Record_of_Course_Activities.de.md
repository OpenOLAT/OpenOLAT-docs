...
Kursbesitzer und sonstige Personen, welche die Berechtigung zur Archivierung haben, können die gewünschten Logfiles als ZIP-Datei (z.B. _CourseLogFiles_2010-01-28_14-55-55.zip_ ) in Ihren [persönlichen Dateien](../personal_menu/File_Hub.de.md#personal_files) abspeichern. Die ZIP-Datei enthält dann die ausgewählten Dateien _course_statistic_log.csv_, _course_admin_log.csv_ und _course_user_log.csv_.

Beachten Sie, dass in der Datei course_statistic_log.csv die Kursteilnehmenden folgendermassen anonymisiert sind:<br>
