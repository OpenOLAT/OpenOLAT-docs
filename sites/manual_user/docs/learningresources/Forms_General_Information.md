...
In forms many different question types like rubric, single selection, multiple selection, text input and file upload are available. Each form consists of a page with one or more questions or elements that are embedded in one or more layouts. Branching is also possible via [Question rules](../learningresources/Form_Question_Rules.md).
...
[To the top of the page ^](#general-information-on-forms)
