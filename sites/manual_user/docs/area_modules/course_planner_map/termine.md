...
Create or import events in the "Events" tab of an implementation via "Add event". If the module "Rooms" is active, assign rooms in the "Rooms" field; coaches can be booked as teachers on events.

## Prerequisites

Implementation exists. For room booking, the module "Rooms" must be active. Only coaches can be made teachers.
