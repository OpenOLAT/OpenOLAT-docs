...
Im Bereich «Reports» eine Vorlage wählen und über den Pfeil in der Spalte «Ausführen» eine Excel-Datei mit den aktuellen Buchungsdaten erzeugen. Erstellte Dateien werden unten aufgelistet und können kopiert und heruntergeladen werden. Analog je Produkt bzw. Durchführung im Tab «Reports».

## Vorbedingungen

Rolle Kursbesitzer:in, Principal oder Administrator:in; vorhandene Buchungsaufträge.
