...
Termine im Tab «Termine» einer Durchführung über «Termin hinzufügen» erstellen oder importieren. Bei aktivem Modul «Räume» im Feld «Räume» Räume zuweisen; Betreuer:innen können als Dozent:innen auf Termine gebucht werden.

## Vorbedingungen

Durchführung vorhanden. Für die Raumbelegung muss das Modul «Räume» aktiv sein. Zu Dozent:innen können nur Betreuer:innen gemacht werden.
