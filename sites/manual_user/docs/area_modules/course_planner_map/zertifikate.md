...
In the "Certification programs" area, create a program via "Create certification program" and set it up in the tabs: link the qualifying implementations in the "Implementations" tab, and define the validity period, recertification and required credit points under `Settings > Configuration`.

## Prerequisites

Course Planner activated; implementations to link exist. For credit points as a prerequisite or means of payment, the module "Credit points" is required.
