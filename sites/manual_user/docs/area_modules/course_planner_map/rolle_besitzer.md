...
Full access (read and write) to the embedded course; members, however, are managed through the implementation, not in the course.
...
[To the top of the page ^](#role_owner)
