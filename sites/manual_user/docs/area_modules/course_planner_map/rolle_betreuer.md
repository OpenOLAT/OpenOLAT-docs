...
Coaches participants in courses and implementations: own events, recording of absences and a coaching view of the coached persons.

## Access

Accompanies participants of an implementation or a course with access to the assessment tool; only coaches can be booked as teachers on events.
...
[To the top of the page ^](#role_coach)
