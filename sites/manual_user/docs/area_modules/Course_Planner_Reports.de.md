# Course Planner: Reports [:octicons-tag-16:{ title="ab Release 20.3 (OO-9209)" }](https://track.frentix.com/issue/OO-9209) {: #reports}
...
- Administrator:in
- Kursplaner:in
- Produktbesitzer:in (für die eigenen Produkte)
- Principal

!!! info "Wichtig"
    Die Reports beziehen sich jeweils auf die Organisation der ausführenden Person und sind damit nicht organisationsübergreifend.

![Der Button Reports, hervorgehoben auf der Startseite des Course Planners](assets/course_planner_reports1_v3_de.png){ class="shadow lightbox" }  

Für die Erstellung von Reports stehen folgende Vorlagen zur Verfügung:

- Alle Buchungsaufträge
- Alle Buchungsaufträge, aktuelles Geschäftsjahr
- Alle Buchungsaufträge, letztes Geschäftsjahr
- Neue Buchungsaufträge, letzte 7 Tage
- Neue Buchungsaufträge, letzte 4 Wochen
- Neue Buchungsaufträge, letzte 12 Monate
...
![Die Spalte Ausführen mit den Pfeilen je Reportvorlage, hervorgehoben im Bereich Reports des Course Planners](assets/course_planner_reports2_v1_de.png){ class="shadow lightbox" }  
...
![Der Bereich Generierter Report mit einer Excel-Datei und den Aktionen Info, Kopieren nach, Löschen und Herunterladen, hervorgehoben im Bereich Reports](assets/course_planner_reports3_v1_de.png){ class="shadow lightbox" } 
...
Der Buchungsbericht enthält alle Buchungsarten. Der erzeugte Excel-Export ist in mehrere Arbeitsblätter gegliedert:

- Arbeitsblatt «Alle»: sämtliche Buchungen des gewählten Zeitraums, unabhängig vom Angebotstyp.
- Ein zusätzliches Arbeitsblatt pro Angebotstyp (zum Beispiel Rechnung, Frei, Zugangscode).
...
[Reports: Buchungsaufträge >](../../manual_user/area_modules/Reports_BookingOrders.de.md)
