...
![Tabs Favoriten, Meine Gruppen, Inaktive Gruppen, Veröffentlichte Gruppen und Suche, dazu der Button Gruppe erstellen, Menü Gruppen](assets/group_management_menu_participants_v1_de.png){ class="shadow lightbox" }
...
![Zwei ausgewählte Gruppen und darüber die Buttons Duplizieren, Zusammenführen, Konten verwalten, Konfigurieren, E-Mail versenden, Inaktivieren und Löschen, Tab Meine Gruppen](assets/group_management_my_groups_v1_de.png){ class="shadow lightbox" }
...
* **Konten verwalten**: Für die ausgewählten Gruppen können bereits eingeschriebene Mitglieder aus der Gruppe entfernt werden, neue Benutzer:innen als Betreuer:innen oder Teilnehmer:innen hinzugefügt oder auf die Warteliste gesetzt werden.
...
* **Löschen**: Als Gruppenbetreuer:in können Sie alle von Ihnen betreuten Gruppen löschen. Wenn die Gruppe mit einem Kurs verbunden ist, wird nur die Gruppe nicht der Kurs gelöscht.

!!! note "Hinweis"

    Damit Sie die entsprechenden Optionen sehen und nutzen können, müssen Sie mindestens eine Gruppe ausgewählt haben und Betreuer:in der Gruppe sein.
...
![Tab Gruppenverwaltung mit den drei Lebenszyklus-Stufen Aktive, Inaktive und Gelöschte Gruppen samt Fristen und Methode, Menü Gruppen für Gruppenverwalter:innen](assets/group_management_menu2_groupmanager_v1_de.png){ class="shadow lightbox" }
...
Gruppenverwalter:innen können zudem Gruppen ohne Mitglieder und Kursanbindung finden und löschen. Auch haben sie Zugriff auf den Gruppen-Lebenszyklus und können den Löschprozess starten oder Gruppen reaktivieren. Mehr Informationen zum automatischen Gruppen-Lebenszyklus finden Sie im [Administrationshandbuch](../../manual_admin/administration/Automatic_Group_Lifecycle.de.md).

Darüber hinaus können Gruppenverwalter:innen auch die Quota des Werkzeugs "Ordner" einer Gruppe ändern.

![Eintrag Quota bearbeiten im Menü mit den drei Punkten der Ordner-Toolbar, Werkzeug Ordner einer Gruppe](assets/Grupppe_Ordner_Gruppenbetreuer.png){ class="shadow lightbox" }
