# Allgemeines zum Portfolio {: #portfolio_general_information}

Mit Hilfe von ePortfolios können Lernende ihre Lern- und Entwicklungsprozesse gestalten, dokumentieren und reflektieren. Im Portfolio 2.0 von OpenOlat können verschiedene Portfoliotypen umgesetzt werden.
...
Portfolio ist nicht gleich Portfolio. Es wird zwischen diversen Typen und Einsatzzwecken unterschieden. Hier einige Beispiele, die sich alle auch mit OpenOlat realisieren lassen:
  ...
  * **Lernportfolio**: Die Ersteller:in ist gleichzeitig auch Besitzer:in des Portfolios und erstellt das Portfolio grundsätzlich aus Eigenmotivation. So können Lernende z.B. ihr gesamtes Studium, ein Semester oder spezifische thematische Bereiche reflexiv begleiten (Selbstevaluation).

  * **Bewertungsportfolio**: Die Reflexion wird als Teil eines Lehr-/Lernprozesses eingesetzt. Den Lernenden werden Aufgaben vorgegeben, die mit Bewertungskriterien verknüpft sind. Die Bearbeitung des Portfolios wird somit fremdbestimmt. Häufig sind die Lernenden dabei nicht Besitzer:innen des Portfolios oder arbeiten mit einem vorstrukturierten Portfolio.

  * **Entwicklungsportfolio**: Die eigene Entwicklung wird mit diversen Artefakten dokumentiert. Lernende dokumentieren ihre Weiterentwicklung über einen längeren Zeitraum und sammeln dabei alle relevanten Artefakte in ihrem ePortfolio. Bei Bedarf können sie aus diesen Entwicklungsdokumenten später noch unterschiedliche Portfoliomappen gestalten.

  * **Präsentationsportfolio**: Die Ersteller:in des Portfolios präsentiert hiermit sich selbst oder eigene Projekte. Dieser Portfoliotyp kann z.B. auch in Form eines Bewerbungsportfolios genutzt werden. Hierfür stellt die Benutzer:in gesammelte Artefakte unter eine bestimmte Fragestellung oder für einen bestimmten Zweck bzw. für eine bestimmte Zielgruppe.
...
Ein Portfolio hat mehrere Vorteile:
  ...
  * Die Nutzer:innen eines Portfolios können Inhalte aller Art sammeln, beschreiben und analysieren. Vor allem die elektronische Abspeicherung vereinfacht diesen Prozess.
...
Natürlich gibt es auch bei Portfolios Nachteile:
  ...
  * Die Grundidee eines Portfolios ist es, die Ersteller:in in den Mittelpunkt zu stellen (Selbstbestimmtheit). Stark von aussen vorgegebene Portfolios entsprechen nicht dieser Grundvorstellung. Hinzu kommt, dass in diesem Fall das Portfolio von der Nutzer:in so ausgefüllt wird, wie es der "Auftraggeber" gerne haben möchte, und nicht so, wie die Nutzer:in es selbst gestalten würde. Die offene Selbstreflexion kann dadurch verloren gehen.
...
[E-Portfolio >](https://www.e-teaching.org/lehrszenarien/pruefung/pruefungsform/eportfolio/)<br>
...
[Zum Seitenanfang ^](#portfolio_general_information)
