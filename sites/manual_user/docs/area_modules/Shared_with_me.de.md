...
![Link Zeige an mich freigegebene Mappen im Öffentlichen Bereich der Portfolio-Übersicht, der Tooltip beschreibt ihn als Liste aller Mappen, die andere Personen an Sie freigegeben haben](assets/portfolio_an_mich_freigegeben1.png){ class="shadow lightbox" }
...
![Tab Mappen unter An mich freigegeben: Tabelle mit Vorname, Titel, Kurs, Letzte Aktualisierung, Offen, Bereiche, Neu und Bewertung, darüber die Filter Alle anzeigen, Offene Sektionen und Neue anzeigen](assets/An_mich_freigegeben.jpg){ class="shadow lightbox" }
...
Über die Filter "Alle anzeigen", "Offene Sektionen" und "Neue anzeigen" grenzen Sie die Liste ein, zum Beispiel gezielt auf Mappen mit noch offenen Bereichen.
