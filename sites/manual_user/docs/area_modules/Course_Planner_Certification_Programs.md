...
## What is a Certification Program? {: #description}
...
| Course administration > Settings > <br> Tab Assessment| Course Planner > Certificate Program |
...
## Create certificate program {: #create}
...
## Certification program configuration {: #config}
...
In **Course Planner > Certification Programs > "Members" tab**, you will find a list of all participants in the certification program. **Click on the plus sign** in front of a list entry to open the detailed view.
...
## Recertification with the certification program {: #recertification}
...
(Course Planner > Certification Program > Settings tab > Configuration button)
...
Course Planner > Certification program > Tab Members > Select member > 3 Points
...
(Course Planner > Certification progr<m> > Tab Settings > Button Configuration > Section Receertification)
