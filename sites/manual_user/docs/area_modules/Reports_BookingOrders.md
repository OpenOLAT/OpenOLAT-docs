...
| Org ID (product)           | Product                | Organisation identifier of the product                            |                                                                 |
...
| Implementation type        | Implementation         | Element type of the implementation                                 |                                                                 |
...
| Execution from             | Implementation         | Begin date of the execution period of the implementation           |                                                                 |
| Execution to               | Implementation         | End date of the execution period of the implementation            |                                                                 |
...
| Offer type	                 | Booking order          | Type of the booked offer                                          |                                                                 |
...
| Passed                     | Course progress/status | Number of "Passed"                                                | :material-checkbox-marked-outline: "Course progress and status" |
...
| Progress                   | Course progress/status | Cumulative progress of the implementation or course (standalone) | :material-checkbox-marked-outline: "Course progress and status" |
| Certificate                | Course progress/status | Number of certificates                                             | :material-checkbox-marked-outline: "Course progress and status" |
