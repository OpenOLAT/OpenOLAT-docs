...
Groups of people can be searched for or added using the "Add participants" button. An invitation via e-mail list is also possible.
...
* Column **Email on completion**:<br> The recipients listed in the 1st column receive an e-mail as soon as a report has been generated.
