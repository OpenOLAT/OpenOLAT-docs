...
[Repository](https://gitlab.vcrp.de/openolat/zertifikatsbot){:target="_blank”} mit dem
...
???+ note "Hier eine Übersicht über die wichtigsten Variablen:"  
    ...
    Beispiel: $dateNextRecertificationRaw = 15.11.2021  
      
    Relatives Datum kurz:

    $formatter.formatDateRelative(Originaldatum, "Sprachcode", +/- Tage, +/-  Monate, +/- Jahre)    
    ...
    $formatter.formatDateLongRelative(Originaldatum, "Sprachcode", +/- Tage, +/- Monate, +/- Jahre)
