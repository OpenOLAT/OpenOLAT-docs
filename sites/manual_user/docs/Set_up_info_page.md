...
search by the type displayed.
  ...
  5. [Authoring](Authoring.html)
  6. [Detailed View of Learning Resources](Detailed+View+of+Learning+Resources.html)
  7. [Set up info page](Set+up+info+page.html)

Sie sind nicht angemeldet. Ihre Änderungen werden mit anonym markiert. Sie
sollten sich
[anmelden](https://confluence.openolat.org/login.action?os_destination=%2Fdisplay%2FOO161EN%2FSet%2Bup%2Binfo%2Bpage),
