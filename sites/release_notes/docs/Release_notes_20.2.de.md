...
![Anzahl Features und Bugs in Release 20.2](assets/202/Features_Improvements_Labels_20.2_DE.png)
...
![Benachrichtigungen Zertifikatsprogramm](assets/202/CertificationProgram_notification_DE.png){ class="shadow lightbox" title="Benachrichtigungen Zertifikatsprogramm" }
...
![Einstellungen Kreditpunktesystem](assets/202/CertificationProgram_credits_DE.png){ class="shadow lightbox" title="Einstellungen Kreditpunktesystem" }
...
![Betreuer:innen-Widget CoachingTool](assets/202/Coaching_favorites_DE.png){ class="shadow lightbox" title="Betreuer:innen-Widget CoachingTool" }
...
![Download pro Essay-Frage](assets/202/Essay_participants_pdf.png){ class="shadow lightbox" title="Download pro Essay-Frage" }

![Essay-Download mit PDF-Output](assets/202/Essay_correct_pdfs.png){ class="shadow lightbox" title="Essay-Download mit PDF-Output" }
...
![Kurs-Template-Aktionen](assets/202/Authoring_template_DE.png){ class="shadow lightbox" title="Kurs-Template-Aktionen" }
...
* [YouTrack Release Notes 20.2.3](https://track.frentix.com/releaseNotes/OO?q=fix%20version:%2020.2.3&title=Release%20Notes%2020.2.3){:target="_blank"}
* [YouTrack Release Notes 20.2.2](https://track.frentix.com/releaseNotes/OO?q=fix%20version:%2020.2.2&title=Release%20Notes%2020.2.2){:target="_blank"}
* [YouTrack Release Notes 20.2.1](https://track.frentix.com/releaseNotes/OO?q=fix%20version:%2020.2.1&title=Release%20Notes%2020.2.1){:target="_blank"}
