...
*German: Zugangskontrolle* · [Manual](https://docs.openolat.org/manual_admin/administration/Core_functions/)
...
*German: Buchungsauftrag* · [Manual](https://docs.openolat.org/manual_user/personal_menu/Bookings/)
...
*German: Katalog* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Catalog_2.0/)
...
*German: Kreditpunkte* · [Manual](https://docs.openolat.org/manual_user/personal_menu/Credit_Points/)
...
*German: Rechnung* · [Manual](https://docs.openolat.org/manual_admin/administration/Payment_Invoice/)
...
*German: Launcher* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Catalog_2.0/)
...
*German: Angebot* · [Manual](https://docs.openolat.org/manual_user/area_modules/catalog2.0_angebote/)

### PayPal

The connection to PayPal as a payment method for paid offers.

*German: PayPal* · [Manual](https://docs.openolat.org/manual_admin/administration/Payment_PayPal/)
...
*German: Web-Katalog* · [Manual](https://docs.openolat.org/manual_user/area_modules/catalog2.0_web/)
...
*German: Automatisierung* · [Manual](https://docs.openolat.org/manual_user/area_modules/Course_Planner_Implementations/)
...
*German: Automatisierungsregel* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Course_Planner/)
...
*German: Course Planner* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Course_Planner/)
...
*German: Bildungsprodukte* · [Manual](https://docs.openolat.org/manual_user/area_modules/Coaching_Educational_Products/)
...
*German: Elementtyp* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Course_Planner/)
...
*German: Durchführung* · [Manual](https://docs.openolat.org/manual_user/area_modules/Course_Planner_Implementations/)
...
*German: Produkt* · [Manual](https://docs.openolat.org/manual_user/area_modules/Course_Planner_Products/)
...
*German: Reports* · [Manual](https://docs.openolat.org/manual_user/area_modules/Course_Planner_Reports/)
...
*German: Zeitabschnitt* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Time_Period/)
...
*German: To-do* · [Manual](https://docs.openolat.org/manual_user/area_modules/Course_Planner_Todos/)
...
*German: Annotation* · [Manual](https://docs.openolat.org/manual_user/learningresources/Learning_resource_Video/)
...
*German: Audio/Video-Aufnahme* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Audio_Video_Recording/)
...
*German: Blog* · [Manual](https://docs.openolat.org/manual_user/learningresources/Blog/)

### Chapter

A jump mark in the video. Learners pick a chapter and land at that point.

*German: Kapitel* · [Manual](https://docs.openolat.org/manual_user/learningresources/Learning_resource_Video/)

### Comment

An overlay as text or as a short video that gives extra information at one point of the video.

*German: Kommentar* · [Manual](https://docs.openolat.org/manual_user/learningresources/Learning_resource_Video/)
...
*German: Kommentare und Bewertungen*
...
*German: Kompetenz* · [Manual](https://docs.openolat.org/manual_user/personal_menu/Competences/)
...
*German: CP-Lerninhalt* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_CP_Learning_Content/)
...
*German: Glossarbegriffe einbinden*
...
*German: Episode* · [Manual](https://docs.openolat.org/manual_user/learningresources/Podcast_listen_and_watch/)
...
*German: Datei* · [Manual](https://docs.openolat.org/manual_dev/ux/file/)
...
*German: Glossar* · [Manual](https://docs.openolat.org/manual_user/learningresources/Glossary/)
...
*German: Lernressource* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Learning_Resource/)
...
*German: Lost+found* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Taxonomy/)
...
*German: Podcast* · [Manual](https://docs.openolat.org/manual_user/learningresources/Podcast/)
...
*German: Quiz* · [Manual](https://docs.openolat.org/manual_user/learningresources/Learning_resource_Video/)
...
*German: Segment* · [Manual](https://docs.openolat.org/manual_user/learningresources/Learning_resource_Video/)

### Subtitles

A subtitle track for the video, one WebVTT file per language. OpenOlat can also generate them itself.

*German: Untertitel* · [Manual](https://docs.openolat.org/manual_user/learningresources/Learning_resource_Video/)
...
*German: Taxonomie* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Taxonomy/)

### Taxonomy level

A node in a taxonomy. It classifies learning resources, questions and documents and can be used as a competence.

*German: Taxonomieebene*
...
*German: Test* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Test/)
...
*German: Test (QTI 1.2 - nicht mehr unterstützt)* · [Manual](https://docs.openolat.org/manual_user/learningresources/Changing_from_QTI_1.2_to_QTI_2.1/)
...
*German: Timeline* · [Manual](https://docs.openolat.org/manual_user/learningresources/Learning_resource_Video/)
...
*German: Transkodierung* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Video/)
...
*German: Video* · [Manual](https://docs.openolat.org/manual_user/learningresources/Learning_resource_Video/)
...
*German: Video-Editor* · [Manual](https://docs.openolat.org/manual_user/learningresources/Learning_resource_Video/)
...
*German: Wiki* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Wiki/)
...
*German: Audio* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)

### Citation

A highlighted quotation with its source. It lives as a medium in the Media Center and can be used more than once.

*German: Zitat* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)

### Code example

A block of source code with syntax highlighting, optionally with line numbers and a copy button.

*German: Code-Beispiel* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)

### Container

A layout frame that holds other content elements in columns. It sets the number of columns and the spacing.

*German: Container* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)
...
*German: Content Editor* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)
...
*German: Inhaltselement* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)

### Diagram

A drawing made with draw.io on a page: a flowchart, a process, an org chart. It stays editable.

*German: Diagramm* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)

### Document (Content and media)

A file on a page, to download or as an embedded preview.

*German: Dokument* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)

### Gallery

Several images as a gallery on a page, with thumbnails and a large view.

*German: Galerie* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)

### HTML text code

A block of raw HTML, for embeddings no other element covers.

*German: HTML-Textcode* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)

### Image (Content and media)

An image on a page. It comes from the Media Center and is therefore available across courses.

*German: Bild* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)

### Image comparison

Two images on top of each other with a slider that moves between them.

*German: Bildvergleich* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)
...
*German: Inspektor* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)

### Math formula

A formula written in LaTeX and rendered as typeset mathematics.

*German: Mathematische Formel* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)
...
*German: Media Center* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Media_Center_Concept/)
...
*German: Quiz* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)

### Separator

A horizontal line that separates two sections of a page.

*German: Separator* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)
...
*German: Freigaben* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Media_Center/)

### Table

A table, entered directly on the page.

*German: Tabelle* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)

### Table of contents

A list built from the titles of the page, which grows with them.

*German: Inhaltsverzeichnis* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)

### Text

A block of text with the full formatting toolbar. The most common content element of a page.

*German: Text* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)

### Title

A heading on the page, in one of six levels.

*German: Titel* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)

### Video (Content and media)

A video on a page, either as a file from the Media Center or through a URL from YouTube or Vimeo.

*German: Video* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)
...
*German: Zugangskonfiguration* · [Manual](https://docs.openolat.org/manual_user/learningresources/Access_configuration/)
...
*German: Freigabe Betreuer:innen*
...
*German: Zusatzbedingung* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Reminders/)
...
*German: Adobe Connect* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Adobe_Connect/)
...
*German: Termin* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Appointment_Scheduling/)
...
*German: Terminbuchung* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Appointment_Scheduling/)
...
*German: Terminfindung* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Appointment_Scheduling/)
...
*German: Terminplanung* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Appointment_Scheduling/)
...
*German: Archivierung & Reports* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Archiving/)
...
*German: Bewertung* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Assessment/)
...
*German: BigBlueButton* · [Manual](https://docs.openolat.org/manual_user/learningresources/bigbluebutton/)
...
*German: Blog* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Blog/)

### Calendar (Course)

A course element that ties the course calendar into the course menu.

*German: Kalender* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Calendar/)
...
*German: card2brain Lernkarten* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_card2brain_Flashcards/)
...
*German: Checkbox* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Checklist/)
...
*German: Checkliste* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Checklist/)
...
*German: Unterlagen Betreuer:innen* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Settings_Toolbar/)
...
*German: Gesamtarchiv* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Archiving/)
...
*German: Bedingung* · [Manual](https://docs.openolat.org/manual_user/learningresources/General_Configuration_of_Course_Elements/)

### Consents

The recorded consents of a person to the terms of use, with the point in time and the version of the text.

*German: Einwilligungen* · [Manual](https://docs.openolat.org/manual_user/learningresources/Members_management/)
...
*German: Kurs* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Course/)
...
*German: Kursarchiv* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Archiving/)
...
*German: Kurseditor* · [Manual](https://docs.openolat.org/manual_user/learningresources/Learning_path_course_Course_editor/)

### Course element

An element that can be added to the course structure in the course editor.

*German: Kursbaustein* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Elements/)

### Course execution

The counter of how often a person has run through the same course: the first run or a repetition for recertification.

*German: Kursdurchführung*
...
*German: Kurserinnerungen* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Course_Reminders/)
...
*German: Kurs Statistiken* · [Manual](https://docs.openolat.org/manual_user/learningresources/Statistics_Course/)
...
*German: Dokument* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Document/)
...
*German: Edubase* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Edubase/)
...
*German: edu-sharing* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_edu_Sharing/)
...
*German: E-Mail* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_EMail/)

### E-mail message

The text a reminder sends: subject and body, with variables for name, course and course link.

*German: E-Mail-Benachrichtigung* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Reminders/)
...
*German: Einschreibung* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Enrolment/)
...
*German: Einschreibung* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Topic_Broker/)
...
*German: Einschreibevorgang* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Topic_Broker/)
...
*German: Ausnahme* · [Manual](https://docs.openolat.org/manual_user/learningresources/Learning_path_course_Course_editor/)
...
*German: Expertenmodus* · [Manual](https://docs.openolat.org/manual_user/learningresources/Access_Restrictions_in_the_Expert_Mode/)

### External page

A course element that shows an external web page in the course and ties it into the course navigation.

*German: Externe Seite* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_External_Page/)

### File dialog

A course element that combines the folder and the forum. Every uploaded document gets a discussion of its own.

*German: Dateidiskussion* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_File_Dialog/)
...
*German: Ordner* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Folder/)
...
*German: Formular* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Form/)
...
*German: Forum* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Forum/)

### GoToMeeting (Course)

A course element that embeds GoToMeeting and GoToTraining sessions into the course.

*German: GoToMeeting* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_GoToMeeting/)
...
*German: Rangliste* · [Manual](https://docs.openolat.org/manual_user/learningresources/Assessment/)
...
*German: HTML-Seite* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_HTML_Page/)
...
*German: Infoseite* · [Manual](https://docs.openolat.org/manual_user/learningresources/Info_page/)
...
*German: JupyterHub* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_JupyterHub/)
...
*German: Lernpfadkurs* · [Manual](https://docs.openolat.org/manual_user/learningresources/Learning_path_course/)
...
*German: Linkliste* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Link_List/)
...
*German: LTI-Seite* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_LTI_Page/)
...
*German: MediaSite* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Mediasite/)
...
*German: Microsoft Teams* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Microsoft_Teams/)
...
*German: Mitteilungen* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Notifications/)
...
*German: Anlass* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Appointment_Scheduling/)

### Opencast (Course)

A course element that shows video recordings from an Opencast server in the course, as a single recording or as a series.

*German: Opencast* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Opencast/)

### OpenMeetings (Course)

A course element that embeds a room of the web conferencing system Apache OpenMeetings into the course.

*German: OpenMeetings* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_OpenMeetings/)
...
*German: Organisator:in* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Appointment_Scheduling/)
...
*German: Seite* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Page/)

### Partial archive

A course archive with chosen course elements and optionally further objects such as course results or log files.

*German: Teilarchiv* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Archiving/)
...
*German: Teilnehmer:innen Ordner* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Participant_Folder/)
...
*German: Liste der Teilnehmer:innen* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Participant_List/)

### Participants accepted

The group of a topic in the topic assignment that lists the participants accepted for the topic.

*German: Akzeptierte Teilnehmer:innen* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Topic_Assignment/)
...
*German: Teilnahme* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Appointment_Scheduling/)
...
*German: Podcast* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Podcast/)
...
*German: Portfolioaufgabe* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Portfolio_Task/)
...
*German: Übung* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Practice/)
...
*German: Empfänger:innen* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Reminders/)
...
*German: Erinnerung* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Reminders/)
...
*German: Ressourcenordner* · [Manual](https://docs.openolat.org/manual_user/learningresources/Resource_Folder/)

### Responsible for the topic

The group of a topic in the topic assignment that lists the coaches responsible for the topic.

*German: Zuständig für dieses Thema* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Topic_Assignment/)
...
*German: Bedingung* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Reminders/)
...
*German: SCORM 1.2* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_SCORM_Learning_Content/)
...
*German: Auswahl* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Selection/)
...
*German: Auswahl* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Topic_Broker/)
...
*German: Selbsttest* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Self_Test/)
...
*German: Versendete Erinnerung* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Reminders/)
...
*German: Einfacher Modus* · [Manual](https://docs.openolat.org/manual_user/learningresources/General_Configuration_of_Course_Elements/)
...
*German: SMS Erinnerungen* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Course_Reminders/)
...
*German: Ablageordner* · [Manual](https://docs.openolat.org/manual_user/learningresources/Storage_folder/)
...
*German: Struktur* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Structure/)

### Survey

A course element that embeds a form learning resource as a survey. The answers are analysed anonymously.

*German: Umfrage* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Survey/)
...
*German: Thema* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Topic_Broker/)
...
*German: Themenvergabe* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Topic_Assignment/)

### Topic broker

A course element participants use to sign up for working on particular topics themselves.

*German: Themenbörse* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Topic_Broker/)
...
*German: Nicht publizierte Änderungen*
...
*German: Video* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Video/)
...
*German: Video Livestream* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Video_Livestream/)
...
*German: Videoaufgabe* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Video_Task/)

### vitero (Course)

A course element that embeds booked vitero team rooms into the course.

*German: vitero* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_vitero/)
...
*German: Zoom* · [Manual](https://docs.openolat.org/manual_user/learningresources/zoom/)
...
*German: Kalender* · [Manual](https://docs.openolat.org/manual_user/personal_menu/Calendar/)
...
*German: Chat* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Chat/)
...
*German: Kollaborative Werkzeuge*
...
*German: Entscheid* · [Manual](https://docs.openolat.org/manual_user/area_modules/Project_Decisions/)
...
*German: Dokumentenpool* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Document_pool/)
...
*German: Termin* · [Manual](https://docs.openolat.org/manual_user/personal_menu/Calendar/)
...
*German: Extern verwaltete Gruppen*

### Files (collaboration.files)

The files of a course, a group or a project, stored together and searchable together.

*German: Dateien* · [Manual](https://docs.openolat.org/manual_user/area_modules/Project_Files/)
...
*German: Gruppe* · [Manual](https://docs.openolat.org/manual_user/groups/)
...
*German: Gruppen-Lebenszyklus* · [Manual](https://docs.openolat.org/manual_admin/administration/Automatic_Group_Lifecycle/)
...
*German: Gruppenverwaltung* · [Manual](https://docs.openolat.org/manual_user/area_modules/Group_Management/)
...
*German: Information an Mitglieder*
...
*German: Instant-Messaging* · [Manual](https://docs.openolat.org/manual_admin/administration/Instant_Messaging/)
...
*German: Einladungen* · [Manual](https://docs.openolat.org/manual_user/learningresources/Members_management/)
...
*German: Bibliothek* · [Manual](https://docs.openolat.org/manual_user/area_modules/Library/)
...
*German: Kalenderliste* · [Manual](https://docs.openolat.org/manual_user/personal_menu/Calendar/)

### Members

The people of a group with their roles. Coaches manage the members, invite people and keep the waiting list.

*German: Mitglieder* · [Manual](https://docs.openolat.org/manual_user/learningresources/Members_management/)
...
*German: Notiz* · [Manual](https://docs.openolat.org/manual_user/area_modules/Project_Notes/)

### Notes

Personal notes on a course. Only the person writing them sees them, and they are kept after leaving the course.

*German: Notizen* · [Manual](https://docs.openolat.org/manual_user/personal_menu/Notes/)
...
*German: Benachrichtigung* · [Manual](https://docs.openolat.org/manual_dev/ux/Alert/)
...
*German: Projekt* · [Manual](https://docs.openolat.org/manual_user/area_modules/Project_Whiteboard/)
...
*German: Timeline* · [Manual](https://docs.openolat.org/manual_user/area_modules/Project_Timeline/)

### Whiteboard

A shared drawing surface in the project that several people work on at the same time. It is based on draw.io.

*German: Whiteboard* · [Manual](https://docs.openolat.org/manual_user/area_modules/Project_Whiteboard/)
...
*German: Bewertung* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Task/)
...
*German: Zuweisung Betreuende/Teilnehmende* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Task/)
...
*German: Gruppenaufgabe* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Grouptask/)
...
*German: Level* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Practice/)
...
*German: Peer-Review* · [Manual](https://docs.openolat.org/manual_how-to/peer_review/peer_review/)
...
*German: Qualitäts-Feedback für Reviewer:in*

### Return and feedback

The step in which the coaches return the corrected work and their feedback to the participant.

*German: Rückgabe und Feedback* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Task/)
...
*German: Musterlösung* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Task/)
...
*German: Aufgabe* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Task/)
...
*German: Absenz* · [Manual](https://docs.openolat.org/manual_user/personal_menu/Absences/)
...
*German: Absenzenverwaltung* · [Manual](https://docs.openolat.org/manual_user/area_modules/Absence_Management/)
...
*German: Gebäude* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Rooms/)
...
*German: Termin* · [Manual](https://docs.openolat.org/manual_user/learningresources/Toolbar_Events/)
...
*German: Termine und Absenzen* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Events_and_Absences/)
...
*German: Raum* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Rooms/)
...
*German: Raumverwaltung* · [Manual](https://docs.openolat.org/manual_user/area_modules/Course_Planner_Rooms/)
...
*German: Räume* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Rooms/)
...
*German: Raumplanung* · [Manual](https://docs.openolat.org/manual_user/area_modules/Course_Planner_Rooms/)
...
*German: Mappe* · [Manual](https://docs.openolat.org/manual_user/portfolio/Three_steps_to_your_portfolio_binder/)
...
*German: ePortfolio* · [Manual](https://docs.openolat.org/manual_admin/administration/eAssessment_ePortfolio/)
...
*German: Meine Einträge* · [Manual](https://docs.openolat.org/manual_user/area_modules/My_entries/)
...
*German: Meine Portfoliomappen* · [Manual](https://docs.openolat.org/manual_user/area_modules/My_portfolio_binders/)
...
*German: Portfolio 2.0* · [Manual](https://docs.openolat.org/manual_user/personal_menu/Portfolio/)
...
*German: Portfoliovorlage* · [Manual](https://docs.openolat.org/manual_user/learningresources/Portfolio_template_Creation/)
...
*German: Bereich* · [Manual](https://docs.openolat.org/manual_user/learningresources/Portfolio_template_Administration_and_editing/)
...
*German: Von mir freigegeben* · [Manual](https://docs.openolat.org/manual_user/area_modules/Shared_by_me/)
...
*German: An mich freigegeben* · [Manual](https://docs.openolat.org/manual_user/area_modules/Shared_with_me/)
...
*German: Korrekturwerkzeug* · [Manual](https://docs.openolat.org/manual_user/learningresources/Assessing_tests/)
...
*German: Drag and Drop* · [Manual](https://docs.openolat.org/manual_user/learningresources/Test_question_types/)
...
*German: Zeichnen* · [Manual](https://docs.openolat.org/manual_user/learningresources/Test_question_types/)
...
*German: Freitext* · [Manual](https://docs.openolat.org/manual_user/learningresources/Test_question_types/)
...
*German: Lückentext numerisch* · [Manual](https://docs.openolat.org/manual_user/learningresources/Test_question_types/)

### Gap FIB text

A question type with a running text that has gaps built into it. The candidate types the missing text in.

*German: Lückentext* · [Manual](https://docs.openolat.org/manual_user/learningresources/Test_question_types/)
...
*German: Lückentext gemischt* · [Manual](https://docs.openolat.org/manual_user/learningresources/Test_question_types/)
...
*German: Lückentext mit Dropdown* · [Manual](https://docs.openolat.org/manual_user/learningresources/Test_question_types/)
...
*German: Hotspot* · [Manual](https://docs.openolat.org/manual_user/learningresources/Test_question_types/)
...
*German: Hottext* · [Manual](https://docs.openolat.org/manual_user/learningresources/Test_question_types/)
...
*German: Kprim* · [Manual](https://docs.openolat.org/manual_user/learningresources/Test_question_types/)
...
*German: Liste* · [Manual](https://docs.openolat.org/manual_user/area_modules/Question_bank_possible_operations/)
...
*German: Matrix* · [Manual](https://docs.openolat.org/manual_user/learningresources/Test_question_types/)
...
*German: Multiple Choice* · [Manual](https://docs.openolat.org/manual_user/learningresources/Test_question_types/)

### Order

A question type in which the candidate drags texts or images into the right order.

*German: Reihenfolge* · [Manual](https://docs.openolat.org/manual_user/learningresources/Test_question_types/)
...
*German: Pool* · [Manual](https://docs.openolat.org/manual_user/area_modules/Question_Bank_Administration/)
...
*German: Fragenpool* · [Manual](https://docs.openolat.org/manual_user/area_modules/Question_Bank/)
...
*German: Fragetyp* · [Manual](https://docs.openolat.org/manual_user/learningresources/Test_question_types/)
...
*German: Beurteilungsprozess* · [Manual](https://docs.openolat.org/manual_user/area_modules/Question_Bank_Review_Process/)
...
*German: Freigaben* · [Manual](https://docs.openolat.org/manual_user/area_modules/Question_Bank/)
...
*German: Single Choice* · [Manual](https://docs.openolat.org/manual_user/learningresources/Test_question_types/)

### Supervisor chat

A chat during an exam. Candidates ask their questions in it, the supervisor answers.

*German: Betreuer:innen-Chat*
...
*German: Testquittung* · [Manual](https://docs.openolat.org/manual_how-to/achievements/achievements/)
...
*German: Test Statistiken* · [Manual](https://docs.openolat.org/manual_user/learningresources/Statistics_Test/)
...
*German: True/false* · [Manual](https://docs.openolat.org/manual_user/learningresources/Test_question_types/)
...
*German: Datei hochladen* · [Manual](https://docs.openolat.org/manual_user/learningresources/Test_question_types/)
...
*German: Prüfungseinsicht* · [Manual](https://docs.openolat.org/manual_user/learningresources/Assessment_inspection/)
...
*German: Prüfungsverwaltung* · [Manual](https://docs.openolat.org/manual_user/learningresources/Assessment_Management/)
...
*German: Prüfungsmodus* · [Manual](https://docs.openolat.org/manual_user/learningresources/Assessment_mode/)
...
*German: Bewertungsaufträge* · [Manual](https://docs.openolat.org/manual_user/area_modules/Coaching_Assessment_Orders/)

### Assessment tool

The area of a course where coaches and owners see, assess, release and reset all results of the participants.

*German: Bewertungswerkzeug* · [Manual](https://docs.openolat.org/manual_user/learningresources/Assessment_tool_overview/)

### Bulk assessment

Assessing many participants in one pass, through an uploaded table or an input form. It saves opening every single person.

*German: Massenbewertung* · [Manual](https://docs.openolat.org/manual_how-to/bulk_assessment/bulk_assessment/)
...
*German: Kurse* · [Manual](https://docs.openolat.org/manual_user/area_modules/Coaching_Courses/)
...
*German: Nachteilsausgleich* · [Manual](https://docs.openolat.org/manual_admin/usermanagement/Configure_User/)
...
*German: Termine / Absenzen* · [Manual](https://docs.openolat.org/manual_user/area_modules/Coaching_Events_Absences/)
...
*German: Generierter Report* · [Manual](https://docs.openolat.org/manual_user/area_modules/Coaching_Reports/)
...
*German: Bewertungssystem* · [Manual](https://docs.openolat.org/manual_admin/administration/Assessment_translate_points_in_grades_admin/)
...
*German: Gruppen* · [Manual](https://docs.openolat.org/manual_user/area_modules/Coaching_Groups/)
...
*German: Einstufung/Noten* · [Manual](https://docs.openolat.org/manual_user/learningresources/Assessment_translate_points_in_grades/)
...
*German: Auftragsverwaltung* · [Manual](https://docs.openolat.org/manual_user/area_modules/Coaching_Order_Management/)
...
*German: Personen* · [Manual](https://docs.openolat.org/manual_user/area_modules/Coaching_People/)
...
*German: Reports* · [Manual](https://docs.openolat.org/manual_user/area_modules/Coaching_Reports/)
...
*German: Reportvorlagen* · [Manual](https://docs.openolat.org/manual_user/area_modules/Coaching_Reports/)
...
*German: Rubrik-Bewertung* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_Assessment/)
...
*German: Personensuche* · [Manual](https://docs.openolat.org/manual_user/area_modules/Coaching_User_Search/)
...
*German: Vergebener Badge* · [Manual](https://docs.openolat.org/manual_user/personal_menu/OpenBadges/)
...
*German: Badge* · [Manual](https://docs.openolat.org/manual_user/personal_menu/OpenBadges/)
...
*German: Zertifikat* · [Manual](https://docs.openolat.org/manual_user/personal_menu/Certificates/)
...
*German: Zertifikatsvorlage* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Settings_Assessment_Certificate/)
...
*German: Zertifikatsprogramm* · [Manual](https://docs.openolat.org/manual_user/area_modules/Course_Planner_Certification_Programs/)

### Evidence of achievement

The collection of all results a person has in a course, one per assessable course element, with points, status and date.

*German: Leistungsnachweis* · [Manual](https://docs.openolat.org/manual_user/personal_menu/Evidence_of_Achievements/)
...
*German: Mitgliedschaft* · [Manual](https://docs.openolat.org/manual_user/area_modules/Course_Planner_Certification_Programs/)
...
*German: OpenBadges* · [Manual](https://docs.openolat.org/manual_user/personal_menu/OpenBadges/)
...
*German: Rezertifizierung* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Settings_Assessment_Certificate/)
...
*German: Vorlage* · [Manual](https://docs.openolat.org/manual_admin/administration/e-Assessment_openBadges/)
...
*German: Verifizierung* · [Manual](https://docs.openolat.org/manual_admin/administration/e-Assessment_openBadges/)
...
*German: Massnahmen To-dos* · [Manual](https://docs.openolat.org/manual_user/area_modules/Quality_Management_To-dos/)
...
*German: Analyse* · [Manual](https://docs.openolat.org/manual_user/area_modules/Quality_Management_Analysis/)
...
*German: Datenerhebung* · [Manual](https://docs.openolat.org/manual_user/area_modules/Quality_Management_Data_Collections/)
...
*German: Datenerhebungsgenerator* · [Manual](https://docs.openolat.org/manual_user/area_modules/Quality_Management_Data_Collection_Generators/)
...
*German: Datenerhebungsvorschau* · [Manual](https://docs.openolat.org/manual_user/area_modules/Quality_Management_Data_Collection_Preview/)
...
*German: Formular* · [Manual](https://docs.openolat.org/manual_user/learningresources/Form/)
...
*German: Heatmap* · [Manual](https://docs.openolat.org/manual_user/area_modules/Quality_Management_Analysis/)
...
*German: Mehrfachauswahl* · [Manual](https://docs.openolat.org/manual_user/learningresources/Form_Elements/)
...
*German: Qualitätsmanagement* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Quality_Management/)
...
*German: Erinnerung* · [Manual](https://docs.openolat.org/manual_user/area_modules/Quality_Management_Data_Collections/)
...
*German: Report* · [Manual](https://docs.openolat.org/manual_user/area_modules/Quality_Management_Data_Collections/)
...
*German: Angaben zur befragten Person* · [Manual](https://docs.openolat.org/manual_user/learningresources/Form_Elements/)
...
*German: Rubrik* · [Manual](https://docs.openolat.org/manual_user/learningresources/Form_Element_Rubric/)

### Single choice (Quality management and forms)

A question in the form with several answers of which exactly one can be chosen.

*German: Einzelauswahl* · [Manual](https://docs.openolat.org/manual_user/learningresources/Form_Elements/)
...
*German: Verbesserungsvorschlag* · [Manual](https://docs.openolat.org/manual_user/area_modules/Quality_Management_Improvement/)

### Terms of use (Quality management and forms)

A text in the form the respondent must agree to before they can submit the form.

*German: Nutzungsbedingungen* · [Manual](https://docs.openolat.org/manual_user/learningresources/Form_Elements/)
...
*German: Textblock* · [Manual](https://docs.openolat.org/manual_user/learningresources/Form_Elements/)

### Trend details

The development of a value across several collections. It shows whether a measure has worked.

*German: Trend Detail* · [Manual](https://docs.openolat.org/manual_user/area_modules/Quality_Management_Analysis/)
...
*German: Datei hochladen* · [Manual](https://docs.openolat.org/manual_user/learningresources/Form_Elements/)
...
*German: Barrierefreiheit* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Accessibility_Colors/)
...
*German: Autorenbereich* · [Manual](https://docs.openolat.org/manual_user/area_modules/Authoring/)
...
*German: Cloud Login* · [Manual](https://docs.openolat.org/manual_admin/administration/Login/)
...
*German: Coaching* · [Manual](https://docs.openolat.org/manual_user/area_modules/Coaching/)
...
*German: Konfiguration* · [Manual](https://docs.openolat.org/manual_user/personal_menu/Personal_Configuration/)
...
*German: Kontaktverfolgung* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Contact_Tracing/)
...
*German: Kontexthilfe* · [Manual](https://docs.openolat.org/manual_user/help/index/)
...
*German: Contexts* · [Manual](https://docs.openolat.org/manual_admin/administration/Customizing/)
...
*German: Core Konfiguration* · [Manual](https://docs.openolat.org/manual_admin/administration/Core_functions/)
...
*German: Course Planner* · [Manual](https://docs.openolat.org/manual_user/area_modules/Course_Planner/)

### Courses (Platform)

The overview of the courses a person is a member of, with the progress and the last access.

*German: Kurse* · [Manual](https://docs.openolat.org/manual_user/area_modules/Courses/)
...
*German: COVID-Zertifikat* · [Manual](https://docs.openolat.org/manual_user/personal_menu/COVID_certificate/)
...
*German: Customizing* · [Manual](https://docs.openolat.org/manual_admin/administration/Customizing/)
...
*German: Dashboard* · [Manual](https://docs.openolat.org/manual_user/area_modules/Course_Planner_Dashboard/)
...
*German: E-Mail Postfach und Versand* · [Manual](https://docs.openolat.org/manual_admin/administration/E-Mail_Settings/)
...
*German: Export* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Archiving/)
...
*German: File Hub* · [Manual](https://docs.openolat.org/manual_user/personal_menu/File_Hub/)
...
*German: Dateien und Ordner* · [Manual](https://docs.openolat.org/manual_admin/administration/Files_and_Folders/)
...
*German: Volltextsuche* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Full_Text_Search/)
...
*German: Gruppen* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Groups/)
...
*German: Gastzugang* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/guest_access/)
...
*German: Hilfe* · [Manual](https://docs.openolat.org/manual_user/help/index/)
...
*German: Info messages* · [Manual](https://docs.openolat.org/manual_admin/administration/System/)
...
*German: Einladungslink* · [Manual](https://docs.openolat.org/manual_admin/administration/Guest_and_invitation/)
...
*German: Startseite* · [Manual](https://docs.openolat.org/manual_admin/administration/Landing_pages/)
...
*German: Lokale OpenOlat-Authentifizierung*
...
*German: Login* · [Manual](https://docs.openolat.org/manual_admin/administration/Login/)
...
*German: Media Center* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Media_Center/)
...
*German: One Time Code* · [Manual](https://docs.openolat.org/manual_user/login_registration/One_Time_Code/)
...
*German: Passkey* · [Manual](https://docs.openolat.org/manual_user/login_registration/Passkey/)
...
*German: Passwort-Syntax* · [Manual](https://docs.openolat.org/manual_admin/administration/Login_Password_and_Authentication/)
...
*German: Portal* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Portal_configuration/)
...
*German: Profil* · [Manual](https://docs.openolat.org/manual_user/personal_menu/Profile/)

### Projects

The area for project work, with events, to-dos, decisions, notes, files and a whiteboard per project.

*German: Projekte* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Projects/)
...
*German: Quota* · [Manual](https://docs.openolat.org/manual_admin/administration/Files_and_Folders/)
...
*German: Registrierung* · [Manual](https://docs.openolat.org/manual_user/login_registration/index/)
...
*German: Reports* · [Manual](https://docs.openolat.org/manual_admin/administration/Reports/)
...
*German: Sicherheit* · [Manual](https://docs.openolat.org/manual_admin/administration/Login_Security/)
...
*German: Selbstregistrierung* · [Manual](https://docs.openolat.org/manual_admin/administration/Login_Self-Registration/)
...
*German: Sites* · [Manual](https://docs.openolat.org/manual_admin/administration/Customizing/)
...
*German: System* · [Manual](https://docs.openolat.org/manual_admin/administration/System/)
...
*German: Einstellungen* · [Manual](https://docs.openolat.org/manual_user/personal_menu/Settings/)
...
*German: Systemeinstellungen* · [Manual](https://docs.openolat.org/manual_user/personal_menu/Settings/)
...
*German: Nutzungsbedingungen* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Terms_Of_Use/)
...
*German: To-do* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_ToDo/)
...
*German: Papierkorb* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Folder_Concept/)
...
*German: Kontoverwaltung* · [Manual](https://docs.openolat.org/manual_admin/usermanagement/)
...
*German: Benutzer:innen-Attribute* · [Manual](https://docs.openolat.org/manual_admin/administration/Customizing/)
...
*German: Aktive Sitzungen* · [Manual](https://docs.openolat.org/manual_admin/administration/System/)
...
*German: Persönliche Werkzeuge* · [Manual](https://docs.openolat.org/manual_user/personal_menu/Personal_Tools/)
...
*German: Versionierung* · [Manual](https://docs.openolat.org/manual_admin/administration/Files_and_Folders/)

### Video Collection

The overview of the video learning resources a person has access to.

*German: Video Collection* · [Manual](https://docs.openolat.org/manual_user/area_modules/Video_Collection/)
...
*German: WebDAV* · [Manual](https://docs.openolat.org/manual_admin/administration/WebDAV/)
...
*German: Absenzenverwalter:in* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Roles/)
...
*German: Administrative Freigabe* · [Manual](https://docs.openolat.org/manual_user/learningresources/Access_configuration/)
...
*German: Administrator:in* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Roles/)
...
*German: Autor:in* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Roles/)
...
*German: Business-Analyst:in / Lieferant:in* · [Manual](https://docs.openolat.org/manual_user/area_modules/Project_Member_Management/)
...
*German: Zertifikatsprogrammbesitzer:in* · [Manual](https://docs.openolat.org/manual_user/area_modules/Course_Planner_Certification_Programs/)
...
*German: Betreuer:in* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/coach/)
...
*German: Kursplaner:in* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_Course_Planner/)
...
*German: Ausbildungsverantwortliche:r* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Roles/)
...
*German: Gruppenverwalter:in* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Roles/)
...
*German: Gast* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Roles/)
...
*German: Einladung* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Roles/)
...
*German: Leiter:in* · [Manual](https://docs.openolat.org/manual_user/area_modules/Project_Member_Management/)
...
*German: Lernressourcenverwalter:in* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Roles/)
...
*German: Linienvorgesetzte:r* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Roles/)
...
*German: Besitzer:in* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Roles/)

### Participant

Course role. A course role. Participants work through the course and see their own results only.

*German: Teilnehmer:in* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Roles/)
...
*German: Projektverwalter:in* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Roles/)
...
*German: Qualitätsverwalter:in* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Roles/)
...
*German: Poolverwalter:in* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Roles/)
...
*German: Rollenverwalter:in* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Roles/)
...
*German: Sponsor:in / Auftraggeber:in* · [Manual](https://docs.openolat.org/manual_user/area_modules/Project_Member_Management/)
...
*German: Systemadministrator:in* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Roles/)
...
*German: Dozent:in* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Roles/)
...
*German: Benutzer:in* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Roles/)
...
*German: Benutzerverwalter:in* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Roles/)
...
*German: Analytics Modul* · [Manual](https://docs.openolat.org/manual_admin/administration/Analytics_module/)
...
*German: card2brain* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_card2brain_Flashcards/)
...
*German: Deep Linking* · [Manual](https://docs.openolat.org/manual_admin/administration/LTI_Deeplinking/)
...
*German: Google Analytics* · [Manual](https://docs.openolat.org/manual_admin/administration/Analytics_module/)
...
*German: LTI* · [Manual](https://docs.openolat.org/manual_admin/administration/LTI_Integrations/)
...
*German: LTI 1.3 Zugangskonfiguration* · [Manual](https://docs.openolat.org/manual_user/learningresources/LTI_Share_courses/)
...
*German: Matomo (Piwik)* · [Manual](https://docs.openolat.org/manual_admin/administration/Analytics_module/)
...
*German: Microsoft SharePoint / OneDrive* · [Manual](https://docs.openolat.org/manual_admin/administration/SharePoint_OneDrive/)
...
*German: OAI-PMH* · [Manual](https://docs.openolat.org/manual_admin/administration/Modules_OAI/)
...
*German: Plattform* · [Manual](https://docs.openolat.org/manual_admin/administration/LTI_External_platforms/)
...
*German: REST API* · [Manual](https://docs.openolat.org/manual_admin/administration/REST_API/)
...
*German: Rollen-Mapping* · [Manual](https://docs.openolat.org/manual_admin/administration/LTI_Role_Mapping/)
...
*German: Raumvorlage* · [Manual](https://docs.openolat.org/manual_admin/administration/BigBlueButton_module/)
...
*German: SCORM* · [Manual](https://docs.openolat.org/manual_user/learningresources/Course_Element_SCORM_Learning_Content/)

### Tool

The external application connected through LTI.

*German: Tool* · [Manual](https://docs.openolat.org/manual_admin/administration/LTI_External_tools/)
...
*German: Virtuelles Klassenzimmer* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Virtual_classrooms/)
...
*German: YouTube API* · [Manual](https://docs.openolat.org/manual_admin/administration/External_Tools_-_Administration/)
...
*German: Zoom* · [Manual](https://docs.openolat.org/manual_admin/administration/Zoom/)
...
*German: Zoom-Profil* · [Manual](https://docs.openolat.org/manual_admin/administration/Zoom/)
...
*German: KI-Aufruf* · [Manual](https://docs.openolat.org/manual_admin/administration/External_Tools_AI/)
...
*German: KI Funktion* · [Manual](https://docs.openolat.org/manual_admin/administration/External_Tools_AI/)
...
*German: KI-Feedback* · [Manual](https://docs.openolat.org/manual_user/basic_concepts/Content_Editor/)
...
*German: KI Modul* · [Manual](https://docs.openolat.org/manual_admin/administration/External_Tools_AI/)
...
*German: KI-Verarbeitungs-Pool* · [Manual](https://docs.openolat.org/manual_admin/administration/External_Tools_AI/)
...
*German: KI Anbieter* · [Manual](https://docs.openolat.org/manual_admin/administration/External_Tools_AI/)

### Anthropic Claude

The AI provider Anthropic Claude, connected through an API key. Using it produces costs on the operator's account.

*German: Anthropic Claude* · [Manual](https://docs.openolat.org/manual_admin/administration/External_Tools_AI/)
...
*German: Generischer KI Anbieter* · [Manual](https://docs.openolat.org/manual_admin/administration/External_Tools_AI/)
...
*German: Bewertungs-Kit (Referenz + Musterantwort)*
...
*German: Bildbeschreibungs-Generator*
...
*German: Pool "Interaktiv" (Threads)*
...
*German: Taxonomie-Zuordnung (Embeddings)*
...
*German: Nutzungsprotokoll* · [Manual](https://docs.openolat.org/manual_admin/administration/External_Tools_AI/)
