...
!!! info "Source data"
    424 FA icons · 1161 OO classes · 8,785 references in source code (`src/main`)
...
| :fontawesome-solid-bell: | `bell` | fa-solid | `o_icon_todo_priority_urgent` |  |  | 5 |
...
| :fontawesome-regular-bookmark: | `bookmark` | fa-regular | `o_icon_bookmark_add` |  |  | 21 |
...
| :fontawesome-solid-calendar: | `calendar` | fa-solid | `o_icon_lifecycle_date` |  |  | 15 |
|  |  |  | `o_icon_proj_appointment` |  |  | 8 |
| :fontawesome-regular-calendar-check: | `calendar-check` | fa-regular | `o_appointment_icon` |  |  | 5 |
|  |  |  | `o_icon_events` | Veranstaltungen | Events | 10 |
| :fontawesome-solid-calendar-check: | `calendar-check` | fa-solid | `o_icon_events` |  |  | 10 |
...
| :fontawesome-solid-calendar-days: | `calendar-days` | fa-solid | `o_portlet_cal_icon` |  |  | 2 |
...
|  |  |  | `o_midpub` |  |  | 6 |
| :fontawesome-solid-check-circle: | `check-circle` | fa-solid | `o_icon_cns_status_done` |  |  | 3 |
|  |  |  | `o_icon_passed` |  |  | 22 |
|  |  |  | `o_icon_proj_milestone_status_achieved` |  |  | 6 |
|  |  |  | `o_icon_qti_summary_correct` |  |  | 12 |
|  |  |  | `o_icon_qual_dc_finished` |  |  | 3 |
...
|  |  |  | `o_mi_qtikprim` |  |  | 5 |
|  |  |  | `o_mi_qtimc` |  |  | 4 |
| :fontawesome-solid-check-square: | `check-square` | fa-solid | `o_icon_checkbox_checked` |  |  | 4 |
|  |  |  | `o_icon_quiz_multiple_choice_correct` |  |  | 6 |
|  |  |  | `o_icon_quiz_multiple_choice_on` |  |  | 6 |
|  |  |  | `o_mi_qtikprim` |  |  | 5 |
...
|  |  |  | `o_icon_slide_up` |  |  | 6 |
|  |  |  | `o_icon_top` |  |  | 4 |
| :fontawesome-regular-circle: | `circle` | fa-regular | `o_icon_circle` |  |  | 6 |
...
| :fontawesome-regular-circle-check: | `circle-check` | fa-regular | `o_icon_absence_authorized` |  |  | 5 |
...
| :fontawesome-solid-circle-down: | `circle-down` | fa-solid | `o_icon_inheritance_root` |  |  | 4 |
...
| :fontawesome-regular-circle-stop: | `circle-stop` | fa-regular | `o_icon_cancel` |  |  | 9 |
...
|  |  |  | `o_icon_memo` |  |  | 5 |
| :fontawesome-solid-clipboard: | `clipboard` | fa-solid | `o_icon_memo` |  |  | 5 |
...
| :fontawesome-regular-clock: | `clock` | fa-regular | `o_ac_status_waiting_icon` |  |  | 5 |
|  |  |  | `o_grader_absence` |  |  | 5 |
...
| :fontawesome-solid-comment: | `comment` | fa-solid | `o_icon_status_chat` |  |  | 8 |
...
| :fontawesome-solid-comments: | `comments` | fa-solid | `o_forum_status_sticky_icon` |  |  | 3 |
|  |  |  | `o_icon_comments` |  |  | 12 |
...
| :fontawesome-regular-copy: | `copy` | fa-regular | `o_icon_files` |  |  | 15 |
|  |  |  | `o_icon_replace` |  |  | 2 |
...
| :fontawesome-solid-envelope: | `envelope` | fa-solid | `o_icon_message` |  |  | 5 |
|  |  |  | `o_icon_send` |  |  | 3 |
...
|  |  |  | `o_icon_proj_file` |  |  | 7 |
|  |  |  | `o_scorm_item` |  |  | 5 |
| :fontawesome-solid-file: | `file` | fa-solid | `o_icon_file` |  |  | 5 |
|  |  |  | `o_icon_inspection` |  |  | 10 |
|  |  |  | `o_icon_pf_entry` |  |  | 5 |
...
| :fontawesome-solid-file-code: | `file-code` | fa-solid | `o_icon_qti_signature` |  |  | 3 |
...
|  |  |  | `o_icon_layout` |  |  | 3 |
| :fontawesome-regular-file-lines: | `file-lines` | fa-regular | `o_icon_file_lines` |  |  | 3 |
...
|  |  |  | `o_page_icon` |  |  | 10 |
|  |  |  | `o_sp_icon` |  |  | 8 |
| :fontawesome-solid-file-text: | `file-text` | fa-solid | `o_icon_log` |  |  | 14 |
|  |  |  | `o_icon_new_document` |  |  | 3 |
|  |  |  | `o_page_icon` |  |  | 10 |
...
| :fontawesome-regular-folder: | `folder` | fa-regular | `o_icon_coursefolder` |  |  | 6 |
...
| :fontawesome-solid-folder-open: | `folder-open` | fa-solid | `o_icon_mediacenter` |  |  | 4 |
...
| :fontawesome-solid-hourglass-half: | `hourglass-half` | fa-solid | `o_icon_candidate` |  |  | 3 |
|  |  |  | `o_icon_payment_open` |  |  | 5 |
|  |  |  | `o_icon_timelimit_half` |  |  | 5 |
...
| :fontawesome-regular-image: | `image` | fa-regular | `o_icon_image_comparison` |  |  | 11 |
...
| :fontawesome-solid-lightbulb: | `lightbulb` | fa-solid | `o_icon_lightbulb` |  |  | 4 |
|  |  |  | `o_icon_qti_solution` |  |  | 2 |
...
| :fontawesome-solid-minus-square: | `minus-square` | fa-solid | `o_icon_review_remove` |  |  | 2 |
...
| :fontawesome-solid-play-circle: | `play-circle` | fa-solid | `o_icon_qual_dc_running` |  |  | 3 |
|  |  |  | `o_icon_qual_exec_participating` |  |  | 2 |
...
| :fontawesome-solid-share-square: | `share-square` | fa-solid | `o_icon_share_social` |  |  | 3 |
...
| :fontawesome-solid-square: | `square` | fa-solid | `o_icon_single_element` |  |  | 4 |
...
| :fontawesome-regular-star: | `star` | fa-regular | `o_icon_qitem_review` |  |  | 4 |
|  |  |  | `o_icon_rating_off` |  |  | 9 |
...
| :fontawesome-regular-sticky-note: | `sticky-note` | fa-regular | `o_icon_notes_empty` |  |  | 3 |
|  |  |  | `o_icon_proj_note` |  |  | 9 |
...
|  |  |  | `o_icon_rejected` |  |  | 8 |
|  |  |  | `o_icon_revision` |  |  | 3 |
| :fontawesome-solid-thumbs-down: | `thumbs-down` | fa-solid | `o_icon_rating_no_on` |  |  | 4 |
|  |  |  | `o_icon_rejected` |  |  | 8 |
|  |  |  | `o_icon_revision` |  |  | 3 |
...
|  |  |  | `o_ms_icon` |  |  | 5 |
| :fontawesome-solid-thumbs-up: | `thumbs-up` | fa-solid | `o_icon_browsercheck` |  |  | 2 |
|  |  |  | `o_icon_pending_confirmations` |  |  | 4 |
|  |  |  | `o_icon_rating_yes_on` |  |  | 4 |
|  |  |  | `o_icon_restore` |  |  | 12 |
...
| :fontawesome-regular-times-circle: | `times-circle` | fa-regular | `o_icon_incorrect_response` |  |  | 4 |
...
|  |  |  | `o_icon_trash` |  |  | 13 |
| :fontawesome-solid-trash-can: | `trash-can` | fa-solid | `o_icon_curriculum_status_deleted` |  |  | 2 |
...
| :fontawesome-regular-user-circle: | `user-circle` | fa-regular | `o_ac_guests_icon` |  |  | 5 |
...
| :fontawesome-solid-users: | `users` | fa-solid | `o_cmembers_icon` |  |  | 6 |
|  |  |  | `o_icon_committee` |  |  | 6 |
|  |  |  | `o_icon_membersmanagement` |  |  | 10 |
|  |  |  | `o_icon_pool_share` |  |  | 7 |
|  |  |  | `o_portlet_groups_icon` |  |  | 2 |
