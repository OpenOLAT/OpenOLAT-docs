...
## Eingeschaltet (Aktivierung des Moduls) {: #activate}

Als Administrator:in entscheiden Sie, ob der Kursbaustein "Externe Seite" den Autor:innen zur Verfügung steht.
...
Sie bestimmen hier ob diese Daten übermittelt werden sollen oder nicht.
