...
and define if the user's real identity or a nickname is shown by default.
 ...
 **Default status for new users:** Use this setting to define the online
status new users start with. The options are "Available", "Please do not
disturb" and "Not available".

 **Receive messages from all users by default:** Use this setting to define
whether the personal setting of the same name is enabled for new users.

Both default values apply as long as a person has not set their own settings
for chat and messaging. After that the personal setting applies: [Personal Configuration: Settings](../../manual_user/personal_menu/Settings.md)
...
[Chat >](../../manual_user/basic_concepts/Chat.md)
