...
![Modules_Time_Period_v1.png](assets/Modules_Time_Period_v1.png){ class="shadow lightbox" }

**The areas created in this way are available as filters in the Authoring area.**
![Modules_Time_Period_authoring_filter_v1.png](assets/Modules_Time_Period_authoring_filter_v1.png){ class="shadow lightbox" }