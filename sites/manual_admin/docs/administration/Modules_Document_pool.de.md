...
![Site Dokumentenpool in der Hauptnavigation mit der Taxonomie links und den Dokumenten der ausgewählten Ebene rechts, hier die Ordner Grammatik und Texte](assets/Dokumentenpool_beispiel_DE.png){ class="shadow lightbox" }
...
ab. Im Bild sind es "Handlungsfeld" und "Fach".
