...
![](assets/Bildschirmfoto 2019-10-10 um 16.20.10.png)

  * 1Konzept
    * 1.1Benutzung
  * 2Sicherheit
    * 2.1Bewährte Vorgehensweise
  * 3Konfiguration
    * 3.1Beispiel
  * 4Dokumentation
  * 5 Extern verwaltete Kurse und Gruppen
...
_/org/Olat/restapi/_spring/restApiContext.xml_ ), oder programmatisch mit dem
Hinzufügen oder Entfernen von Klassen und Singletons zum/vom Bean (Bean Id ist
die selbe wie im Interface: _org.Olat.restapi.support.RestRegistrationService_
).
...
wiederbenutzt.  
**Sehr wichtig!** Alle Konfigurationen müssen vor dem Start des Jersey-
Servlets eingestellt werden.
...
_/org/Olat/restapi/openapi.json_ ) beschrieben sind.
...
verwaltet werden.
 ...
 Managed Curriculumelementtypen
 ...
 Managed Identität zu Identität Verhältnis
