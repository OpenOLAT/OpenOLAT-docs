...
Über das **Benutzer:innen-Attribut** werden die zuvor festgelegten Benutzer:innen (entweder alle Benutzer:innen des Systems oder Benutzer:innen mit einer bestimmten Rolle) weiter eingegrenzt. Das Benutzer:innen-Attribut (z.B. Geschlecht, Land oder Studienfach) wird dann über die Spalte **Wert** definiert. So sind beim Attribut "Geschlecht" die Werte _männlich/weiblich_ möglich, beim Land z.B. _Schweiz, Deutschland_ etc., oder für Studienfach _Informatik, Theologie_ etc. Welche Werte in der Spalte Wert eingetragen werden können, ist von Ihrer Organisation abhängig und davon, wie diese Werte in Ihrer OpenOlat-Instanz verfügbar sind. Benutzer:innen-Attribute können sich des Weiteren abhängig von zuvor vorgenommenen Einstellungen ändern. Eventuell wurden Attribute umbenannt, oder die Liste der verfügbaren Attribute wurde angepasst. Beide Einstellungen finden Sie in der System-Administration unter:<br>
