...
Required minimum version for participants who start the Safe Exam Browser on Windows.

#### Minimal version Mac {: #min_version_mac }

Required minimum version for participants who start the Safe Exam Browser on Mac.
