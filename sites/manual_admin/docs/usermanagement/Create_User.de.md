...
Sofern nichts anderes definiert wurde haben neu angelegte Konten erst einmal
...
der linken Navigation wird dabei als Voreinstellung für den Import
gewählt.

## Temporäre System Benutzer erstellen

Über den Button "Temporär Benutzer erstellen" kann eine bestimmte Anzahl von
Benutzer:innen, z.B. für Testzwecke oder temporäre Events erstellt werden. Dabei kann
...
werden. Auf diese Weise ist die Erstellung von vielen Konten in kürzester
Zeit möglich.
...
deaktivierte Benutzer angezeigt sowie bestimmte Benutzer ausgewählt und gelöscht
