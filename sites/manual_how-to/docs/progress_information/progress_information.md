...
!!! tip "Hint"
    ...
    Variables can also be used in the text of the reminder emails. (See [Variables in the email text of reminders](../../manual_user/learningresources/Course_Reminders.md).) Various variables are available to distinguish between the recipients who were originally contacted and the (alternatively) informed coaches:
