...
3.2 The files of this folder can now be added in the course editor like all other files of the storage folder via course element "[HTML page](../../manual_user/learningresources/Course_Element_HTML_Page.md)".
