...
??? abstract "Windows 10 (also 7, 8, 8.1)"
    ...
    9. Click on "Next."
    10. Now provide your OpenOlat username or the stored e-mail address and password.
    11. Click on "Finish."
...
??? abstract "Windows Vista"
    ...
    8. Click on "Next."
    9. Indicate your OpenOlat username or the stored e-mail address and password.
...
??? abstract "Mac"
    ...
    2. Provide your OpenOlat username or the stored e-mail address and password.
    3. Click on "OK."
...
??? abstract "Linux"
    ...
    2. Gnome: `davs:// + username or e-mail address + @` \+ WebDAV link. Example: `davs://jdoe@www.olat.uzh.ch/olat/webdav/`.
