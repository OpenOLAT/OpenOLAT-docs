# Wie setze ich rechtliche Zustimmungspflichten um? {: #legal_consents}
...
## Fallbeispiel einer Lehrkraft {: #case_study}

Als Betreuer:in eines Kurses zum Thema "Praktikum Patientendaten verwalten" ist Ihnen bewusst, dass alle Kursteilnehmer:innen mit sensiblen Daten zu tun haben werden. Es ist deshalb zwingend erforderlich, dass alle schriftlich eine Erklärung zum Datenschutz akzeptieren müssen.

Weil ein Teil dieses Praktikums auch online stattfindet, möchten Sie sicherstellen, dass Sie als Kursleiter:in in Ihrem Kurs nicht wegen Datenschutzvergehen belangt werden können.

Wie gehen Sie vor?

Nachstehend finden Sie mögliche OpenOlat-Bordmittel und ihren Verwendungszweck beschrieben.
...
- Was ist bereits von allen Nutzer:innen der OpenOlat-Plattform bestätigt worden? 
...
- [x] Welche Einwilligungen mussten die Teilnehmer:innen bereits zur Nutzung der OpenOlat-Lernplattform generell abgeben?
- [x] Die generellen Nutzungsbedingungen und die generelle Datenschutzerklärung liegen mir vor.
- [x] Die generellen Nutzungsbedingungen und die generelle Datenschutzerklärung wurden von allen Kursteilnehmer:innen bereits bestätigt.
- [x] Sind zusätzliche kurspezifische Erklärungen erforderlich?
- [x] Liegen die Texte der kursspezifischen Erklärungen vor?
...
[Nutzungsbedingungen der OpenOlat-Plattform >](../../manual_user/basic_concepts/Terms_Of_Use.de.md#terms_of_use_platform)<br>
